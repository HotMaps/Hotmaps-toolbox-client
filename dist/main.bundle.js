...
var CMLayersService = (function (_super) {
    ...
    CMLayersService.prototype.removelayer = function () {
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__pages_map_map_service__ = __webpack_require__("../../../../../src/app/pages/map/map.service.ts");
...
var CalculationModuleComponent = (function () {
    function CalculationModuleComponent(calculationModuleService, calculationModuleStatusService, mapService, helper, logger) {
...
var ExportDataComponent = (function () {
    function ExportDataComponent(exportDataService, logger, helper) {
        ...
        this.tab = __WEBPACK_IMPORTED_MODULE_4__shared_data_service__["s" /* tab1_datapanel */];
    ...
    ExportDataComponent.prototype.changeButtonState = function () {
        ...
        if ((this.tab === __WEBPACK_IMPORTED_MODULE_4__shared_data_service__["s" /* tab1_datapanel */]) && (this.indicators.layers.length >= 1)) {
            this.displayButton = true;
        }
        else if (this.tab === __WEBPACK_IMPORTED_MODULE_4__shared_data_service__["_6" /* tab2_datapanel */] && this.graphics.length >= 1) {
            this.graphics.map(function (graphic) {
                if (graphic.data.length === 0) {
                    _this.displayButton = false;
                }
            });
        }
        else {
    ...
    ExportDataComponent.prototype.notifyService = function () {
        ...
        this.exportDataService.getTabsSelectedName().subscribe(function (val) {
            ...
            if (val === __WEBPACK_IMPORTED_MODULE_4__shared_data_service__["s" /* tab1_datapanel */]) {
...
__decorate([
    __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_1__angular_core__["Input"])(),
    __metadata("design:type", Object)
], ExportDataComponent.prototype, "heatLoadData", void 0);
__decorate([
    __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_1__angular_core__["Input"])(),
    __metadata("design:type", Object)
], ExportDataComponent.prototype, "tab", void 0);
__decorate([
    __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_1__angular_core__["Input"])(),
    __metadata("design:type", Object)
], ExportDataComponent.prototype, "updateStatus", void 0);
...
var FeedbackComponent = (function () {
    ...
    FeedbackComponent.prototype.sendRequest = function (f) {
        ...
        jQuery.ajax({
            url: __WEBPACK_IMPORTED_MODULE_5__shared_data_service__["_15" /* urlTaigaFeedback */],
            type: 'POST',
            data: fd,
            processData: false,
            contentType: false,
...
var DurationCurveComponent = (function () {
    ...
    DurationCurveComponent.prototype.update = function () {
        ...
        if (this.scaleLevel === '-1') {
            isHectare = true;
            payload = this.helper.createDCPayloadHectares(__WEBPACK_IMPORTED_MODULE_4__shared_data_service__["_7" /* constant_year_duration_curve */], this.durationCurvePayload.areas);
        }
        else {
            payload = this.helper.createDCPayloadNuts(__WEBPACK_IMPORTED_MODULE_4__shared_data_service__["_7" /* constant_year_duration_curve */], this.durationCurvePayload.nuts);
        }
        ...
        this.interactionService.getDurationCurveWithPayload(payload, isHectare).then(function (result) {
            ...
            _this.options = __WEBPACK_IMPORTED_MODULE_4__shared_data_service__["_8" /* duration_curve_graph_options */];
        }).then(function () {
...
var ElectricityMixComponent = (function () {
    ...
    ElectricityMixComponent.prototype.ngOnInit = function () {
        this.options = __WEBPACK_IMPORTED_MODULE_3__shared_data_service__["_5" /* energy_mix_options */];
        /* this.update(); */
    };
    ...
    HeatLoadChartComponent.prototype.update = function () {
        ...
        if (this.buttons_date_type !== undefined) {
            ...
            this.interactionService.getHeatLoad(payload, this.selectedButton.api_ref, isHectare).then(function (result) {
                ...
                _this.options = __WEBPACK_IMPORTED_MODULE_3__shared_data_service__["_9" /* heat_load_graph_options */];
...
var DataInteractionArray = [
    ...
    { id: 20, name: 'CM District Heating Potential', category: 'Calculation module', isSelected: false,
        workspaceName: 'CM District Heating Potential', zoomLevel: 0, ref: ['overall', 'demand', __WEBPACK_IMPORTED_MODULE_0__shared_data_service__["_4" /* calculation_module_category */]], styleName: '' },
];
...
var ResultManagerComponent = (function () {
    ...
    ResultManagerComponent.prototype.updateEnergyMixResult = function () {
        var self = this;
        var graphic = self.addGraphic(__WEBPACK_IMPORTED_MODULE_0__shared_data_service__["_17" /* energy_mix_title */], 'pie', [], [], __WEBPACK_IMPORTED_MODULE_0__shared_data_service__["_5" /* energy_mix_options */], __WEBPACK_IMPORTED_MODULE_0__shared_data_service__["_18" /* energy_mix_graph_category */], true);
    ...
    ResultManagerComponent.prototype.updateHeatLoadResult = function () {
        this.addGraphic(__WEBPACK_IMPORTED_MODULE_0__shared_data_service__["_10" /* heatloadprofile */], 'line', [], [], __WEBPACK_IMPORTED_MODULE_0__shared_data_service__["_9" /* heat_load_graph_options */], 'heatload', true);
    };
    ResultManagerComponent.prototype.updateDurationCurveResult = function () {
        var _this = this;
        var self = this;
        var graphic = self.addGraphic(__WEBPACK_IMPORTED_MODULE_0__shared_data_service__["_19" /* duration_curve_graph_title */], 'line', [], [], __WEBPACK_IMPORTED_MODULE_0__shared_data_service__["_8" /* duration_curve_graph_options */], __WEBPACK_IMPORTED_MODULE_0__shared_data_service__["_20" /* duration_curve_graph_category */], true);
        var isHectare;
        if (this.scaleLevel === '-1') {
            isHectare = true;
        }
            ...
            if (response["state"] === 'SUCCESS') {
                ...
                if (response.status.result.indicator.length >= 1) {
                    _this.result.indicators.layers.push({
                        name: response.status.result.name, values: response.status.result.indicator, category: ['overall', __WEBPACK_IMPORTED_MODULE_0__shared_data_service__["_4" /* calculation_module_category */]]
                    });
                ...
                if (response.status.result.graphics.length >= 1) {
                    response.status.result.graphics.map(function (graphic) {
                        ...
                        var graph = _this.addGraphic(response.status.result.name, graphic.type, graphic.data.datasets, graphic.data.labels, option_calculation_module, __WEBPACK_IMPORTED_MODULE_0__shared_data_service__["_4" /* calculation_module_category */], false);
                    });
                    _this.displayExportDataStatus = true;
                }
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_app_features_calculation_module_component_calculation_module_component__ = __webpack_require__("../../../../../src/app/features/calculation-module/component/calculation-module.component.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__shared_helper__ = __webpack_require__("../../../../../src/app/shared/helper.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__angular_core__ = __webpack_require__("../../../core/@angular/core.es5.js");
        ...
        if (!this.helper.isNullOrUndefined(this.mapService.getNutsSelectedSubject())) {
            this.mapService.getNutsSelectedSubject().subscribe(function (value) {
                if (value === 0) {
                    ...
                    if (_this.mapService.getScaleValue() === __WEBPACK_IMPORTED_MODULE_10__shared_data_service__["n" /* hectare */]) {
...
__decorate([
    __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_2__angular_core__["ViewChild"])(__WEBPACK_IMPORTED_MODULE_0_app_features_calculation_module_component_calculation_module_component__["a" /* CalculationModuleComponent */]),
    __metadata("design:type", typeof (_a = typeof __WEBPACK_IMPORTED_MODULE_0_app_features_calculation_module_component_calculation_module_component__["a" /* CalculationModuleComponent */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_0_app_features_calculation_module_component_calculation_module_component__["a" /* CalculationModuleComponent */]) === "function" && _a || Object)
...
LeftSideComponent = __decorate([
    ...
    __metadata("design:paramtypes", [typeof (_b = typeof __WEBPACK_IMPORTED_MODULE_1__shared_helper__["a" /* Helper */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_1__shared_helper__["a" /* Helper */]) === "function" && _b || Object, typeof (_c = typeof __WEBPACK_IMPORTED_MODULE_4__layers_interaction_layers_interaction_service__["a" /* DataInteractionService */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_4__layers_interaction_layers_interaction_service__["a" /* DataInteractionService */]) === "function" && _c || Object, typeof (_d = typeof __WEBPACK_IMPORTED_MODULE_7__shared_services_logger_service__["a" /* Logger */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_7__shared_services_logger_service__["a" /* Logger */]) === "function" && _d || Object, typeof (_e = typeof __WEBPACK_IMPORTED_MODULE_5_app_shared_services_interaction_service__["a" /* InteractionService */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_5_app_shared_services_interaction_service__["a" /* InteractionService */]) === "function" && _e || Object, typeof (_f = typeof __WEBPACK_IMPORTED_MODULE_8__pages_map_map_service__["a" /* MapService */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_8__pages_map_map_service__["a" /* MapService */]) === "function" && _f || Object])
], LeftSideComponent);
...
var RightSideComponent = (function (_super) {
    ...
    RightSideComponent.prototype.setDurationCurveIds = function () {
        this.durationCurvePayload = { nuts: this.nutsIds, year: __WEBPACK_IMPORTED_MODULE_6__shared_data_service__["_7" /* constant_year_duration_curve */] };
    };
    RightSideComponent.prototype.setDurationCurveAreas = function () {
        this.durationCurvePayload = { areas: this.helper.getAreasForPayload(this.areas), year: __WEBPACK_IMPORTED_MODULE_6__shared_data_service__["_7" /* constant_year_duration_curve */] };
    };
...
var SummaryResultComponent = (function () {
    ...
    SummaryResultComponent.prototype.ngOnChanges = function (changes) {
        ...
        console.log('SummaryResultComponent/ngOnChanges', this.refSelected);
        console.log('SummaryResultComponent/ngOnChanges', this.summaryResult);
    };
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "_15", function() { return urlTaigaFeedback; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "_22", function() { return urlLegend; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "_16", function() { return timeOutAjaxRequest; });
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "_10", function() { return heatloadprofile; });
/* unused harmony export Durationcurve */
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "_17", function() { return energy_mix_title; });
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "_12", function() { return heat_load_api_day; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "_14", function() { return heat_load_api_year; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "_13", function() { return heat_load_api_month; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "_11", function() { return buttons_heat_load; });
/* unused harmony export default_drop_down_button */
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "_4", function() { return calculation_module_category; });
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "_7", function() { return constant_year_duration_curve; });
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "_23", function() { return rightPanelSize; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "_21", function() { return leftPanelSize; });
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "_6", function() { return tab2_datapanel; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "_19", function() { return duration_curve_graph_title; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "_20", function() { return duration_curve_graph_category; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "_8", function() { return duration_curve_graph_options; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "_9", function() { return heat_load_graph_options; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "_18", function() { return energy_mix_graph_category; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "_5", function() { return energy_mix_options; });
...
var calculation_module_category = 'calculation_module';
...
/* harmony namespace reexport (by used) */ __webpack_require__.d(__webpack_exports__, "heatloadprofile", function() { return __WEBPACK_IMPORTED_MODULE_4__data_service__["_10"]; });
/* harmony namespace reexport (by used) */ __webpack_require__.d(__webpack_exports__, "buttons_heat_load", function() { return __WEBPACK_IMPORTED_MODULE_4__data_service__["_11"]; });
/* harmony namespace reexport (by used) */ __webpack_require__.d(__webpack_exports__, "heat_load_api_day", function() { return __WEBPACK_IMPORTED_MODULE_4__data_service__["_12"]; });
/* harmony namespace reexport (by used) */ __webpack_require__.d(__webpack_exports__, "heat_load_api_month", function() { return __WEBPACK_IMPORTED_MODULE_4__data_service__["_13"]; });
/* harmony namespace reexport (by used) */ __webpack_require__.d(__webpack_exports__, "heat_load_api_year", function() { return __WEBPACK_IMPORTED_MODULE_4__data_service__["_14"]; });
/* harmony namespace reexport (by used) */ __webpack_require__.d(__webpack_exports__, "timeOutAjaxRequest", function() { return __WEBPACK_IMPORTED_MODULE_4__data_service__["_16"]; });
/* harmony namespace reexport (by used) */ __webpack_require__.d(__webpack_exports__, "leftPanelSize", function() { return __WEBPACK_IMPORTED_MODULE_4__data_service__["_21"]; });
/* harmony namespace reexport (by used) */ __webpack_require__.d(__webpack_exports__, "rightPanelSize", function() { return __WEBPACK_IMPORTED_MODULE_4__data_service__["_23"]; });
