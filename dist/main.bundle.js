...
var DataInteractionArray = [
    ...
    { id: __WEBPACK_IMPORTED_MODULE_0__shared_data_service__["A" /* idDefaultLayer */], name: 'Heat density total', category: 'Buildings', isSelected: true,
        workspaceName: __WEBPACK_IMPORTED_MODULE_0__shared_data_service__["z" /* defaultLayer */], zoomLevel: 0, ref: ['summary', 'demand', 'load_profile', 'heat_supply'] },
    ...
    { id: 12, name: __WEBPACK_IMPORTED_MODULE_0__shared_data_service__["G" /* business_name_wwtp */], category: 'Res Potential', isSelected: false,
        workspaceName: 'wwtp', zoomLevel: __WEBPACK_IMPORTED_MODULE_1__shared_data_service__["_1" /* zoomLevelDetectChange */], ref: ['climate'] },
    ...
    { id: 14, name: 'Population total', category: 'Population', isSelected: false,
        workspaceName: __WEBPACK_IMPORTED_MODULE_0__shared_data_service__["C" /* populationLayerName */], zoomLevel: 0, ref: ['summary', 'demand'] },
...
var DurationCurveComponent = (function () {
    ...
    DurationCurveComponent.prototype.update = function () {
        ...
        if (this.scaleLevel === '-1') {
            ...
            payload = this.helper.createDCPayloadHectares(__WEBPACK_IMPORTED_MODULE_4__shared_data_service__["_2" /* constant_year_duration_curve */], areas_1);
        }
        else {
            payload = this.helper.createDCPayloadNuts(__WEBPACK_IMPORTED_MODULE_4__shared_data_service__["_2" /* constant_year_duration_curve */], this.nutsIds);
        }
...
var FeedbackComponent = (function () {
    ...
    FeedbackComponent.prototype.sendRequest = function (f) {
        ...
        jQuery.ajax({
            url: __WEBPACK_IMPORTED_MODULE_5__shared_data_service__["_9" /* urlTaigaFeedback */],
            type: 'POST',
            data: fd,
            processData: false,
            contentType: false,
    ...
    HeatLoadChartComponent.prototype.update = function () {
        ...
        if (this.buttons_date_type !== undefined) {
            ...
            this.interactionService.getHeatLoad(payload, this.selectedButton.api_ref, isHectare).then(function (result) {
                ...
                _this.options = __WEBPACK_IMPORTED_MODULE_3__shared_data_service__["_4" /* heat_load_graph_options */];
            }).then(function () {
                _this.loadingData = false;
...
var RightSideComponent = (function (_super) {
    ...
    RightSideComponent.prototype.updateWithIds = function () {
        ...
        var summaryPromise = this.interactionService.getSummaryResultWithIds(payload).then(function (result) {
            ...
            if (_this.helper.isResultEmpty(result)) {
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "_9", function() { return urlTaigaFeedback; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "_10", function() { return timeOutAjaxRequest; });
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "_6", function() { return heat_load_api_day; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "_8", function() { return heat_load_api_year; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "_7", function() { return heat_load_api_month; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "_5", function() { return buttons_heat_load; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "h", function() { return summay_drop_down_buttons; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "_11", function() { return default_drop_down_button; });
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "_4", function() { return heat_load_graph_options; });
...
/* harmony namespace reexport (by used) */ __webpack_require__.d(__webpack_exports__, "buttons_heat_load", function() { return __WEBPACK_IMPORTED_MODULE_4__data_service__["_5"]; });
/* harmony namespace reexport (by used) */ __webpack_require__.d(__webpack_exports__, "heat_load_api_day", function() { return __WEBPACK_IMPORTED_MODULE_4__data_service__["_6"]; });
/* harmony namespace reexport (by used) */ __webpack_require__.d(__webpack_exports__, "heat_load_api_month", function() { return __WEBPACK_IMPORTED_MODULE_4__data_service__["_7"]; });
/* harmony namespace reexport (by used) */ __webpack_require__.d(__webpack_exports__, "heat_load_api_year", function() { return __WEBPACK_IMPORTED_MODULE_4__data_service__["_8"]; });
/* harmony namespace reexport (by used) */ __webpack_require__.d(__webpack_exports__, "timeOutAjaxRequest", function() { return __WEBPACK_IMPORTED_MODULE_4__data_service__["_10"]; });
/* harmony namespace reexport (by used) */ __webpack_require__.d(__webpack_exports__, "default_drop_down_button", function() { return __WEBPACK_IMPORTED_MODULE_4__data_service__["_11"]; });
