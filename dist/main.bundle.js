...
var DataInteractionArray = [
    ...
    { id: __WEBPACK_IMPORTED_MODULE_0__shared_data_service__["w" /* idDefaultLayer */], name: 'Heat Map', category: 'Comsumption', isSelected: true, workspaceName: __WEBPACK_IMPORTED_MODULE_0__shared_data_service__["u" /* defaultLayer */], zoomLevel: 0 },
    { id: 12, name: __WEBPACK_IMPORTED_MODULE_0__shared_data_service__["A" /* business_name_wwtp */], category: 'Ressources', isSelected: false, workspaceName: 'wwtp', zoomLevel: __WEBPACK_IMPORTED_MODULE_1__shared_data_service__["X" /* zoomLevelDetectChange */] },
    { id: 14, name: 'Population', category: 'Comsumption', isSelected: false, workspaceName: __WEBPACK_IMPORTED_MODULE_0__shared_data_service__["x" /* populationLayerName */], zoomLevel: 0 },
];
...
var FeedbackComponent = (function () {
    ...
    FeedbackComponent.prototype.sendRequest = function (f) {
        ...
        jQuery.ajax({
            url: __WEBPACK_IMPORTED_MODULE_5__shared_data_service__["_2" /* urlTaigaFeedback */],
            type: 'POST',
            data: fd,
            processData: false,
            contentType: false,
...
var LayersService = (function (_super) {
    ...
    function LayersService(http, logger, loaderService, toasterService, 
        ...
        _this.heatmapOption = {
            layers: 'hotmaps:' + __WEBPACK_IMPORTED_MODULE_8__shared_data_service__["u" /* defaultLayer */] + '_ha' + '_' + __WEBPACK_IMPORTED_MODULE_8__shared_data_service__["v" /* constant_year */],
            format: __WEBPACK_IMPORTED_MODULE_8__shared_data_service__["g" /* formatImage */], transparent: true, version: '1.3.0',
            zIndex: __WEBPACK_IMPORTED_MODULE_8__shared_data_service__["w" /* idDefaultLayer */]
        };
    ...
    LayersService.prototype.addLayerWithAction = function (action, map, order) {
        var layer;
        if (action === __WEBPACK_IMPORTED_MODULE_8__shared_data_service__["t" /* wwtpLayerName */]) {
            var option = {
            ...
            var option = {
                layers: 'hotmaps:' + action + '_ha' + '_' + __WEBPACK_IMPORTED_MODULE_8__shared_data_service__["v" /* constant_year */],
                format: __WEBPACK_IMPORTED_MODULE_8__shared_data_service__["g" /* formatImage */],
                transparent: true,
                version: '1.3.0',
                srs: 'EPSG:4326',
    ...
    LayersService.prototype.choosePopup = function (map, res, latlng, action) {
        ...
        else if (action === __WEBPACK_IMPORTED_MODULE_8__shared_data_service__["t" /* wwtpLayerName */]) {
            this.addPopupWWTP(map, res, latlng);
        }
        else if (action === __WEBPACK_IMPORTED_MODULE_8__shared_data_service__["x" /* populationLayerName */] + '_' + __WEBPACK_IMPORTED_MODULE_8__shared_data_service__["v" /* constant_year */]) {
    ...
    LayersService.prototype.addPopupWWTP = function (map, data, latlng) {
        ...
        this.popup.setLatLng(latlng).setContent('<h5>' + __WEBPACK_IMPORTED_MODULE_8__shared_data_service__["A" /* business_name_wwtp */] + '</h5> <ul class="uk-list uk-list-divider">' +
            '<li>Capacity: ' + capacity + ' ' + __WEBPACK_IMPORTED_MODULE_8__shared_data_service__["B" /* unit_capacity */] + '</li><li>Power: ' + this.helper.round(power) + ' ' + unit + '</li>' +
    ...
    LayersService.prototype.showWwtpWithMarker = function (map) {
        ...
        var url = __WEBPACK_IMPORTED_MODULE_8__shared_data_service__["f" /* geoserverUrl */] + '?service=wfs' +
            '&version=2.0.0' +
            '&request=GetFeature' +
            '&typeNames=hotmaps:' + __WEBPACK_IMPORTED_MODULE_8__shared_data_service__["t" /* wwtpLayerName */] +
            '&srsName=EPSG:' + epsg +
...
var PopulationService = (function (_super) {
    ...
    */
    PopulationService.prototype.getPopulationWithPayloads = function (payload) {
        return _super.prototype.POST.call(this, payload, __WEBPACK_IMPORTED_MODULE_4__shared_data_service__["a" /* apiUrl */] + __WEBPACK_IMPORTED_MODULE_4__shared_data_service__["V" /* postPopulationDensityInArea */]);
    };
    /**
    ...
    */
    PopulationService.prototype.addPopupNuts = function (data, map, latlng, popup) {
        ...
        popup.setLatLng(latlng).setContent('<h5>' + __WEBPACK_IMPORTED_MODULE_4__shared_data_service__["W" /* business_name_population */] + '</h5> <ul class="uk-list uk-list-divider">' +
...
var SelectionToolService = (function (_super) {
    ...
    SelectionToolService.prototype.loadPopup = function (map, layer) {
        ...
        L.DomEvent.on(this.validationBtnSelection, 'click', function () {
            ...
            if (_this.currentLayer instanceof L.Circle) {
                ...
                var layerNutsArray = [];
                for (var i = 0; i < _this.interactionService.getLayerArray().keys().length; i++) {
                    if (_this.interactionService.getLayerArray().keys()[i] !== __WEBPACK_IMPORTED_MODULE_3__shared_data_service__["t" /* wwtpLayerName */]) {
    ...
    SelectionToolService.prototype.heatloadRequest = function () {
        if ((this.scaleValue === __WEBPACK_IMPORTED_MODULE_3__shared_data_service__["q" /* nuts2 */]) || (this.scaleValue === __WEBPACK_IMPORTED_MODULE_3__shared_data_service__["e" /* nuts3 */])) {
    ...
    SelectionToolService.prototype.clearAll = function (map) {
        // ONLY HECTAR LEVEL
        if (this.scaleValue === __WEBPACK_IMPORTED_MODULE_3__shared_data_service__["s" /* hectare */]) {
            this.editableLayers.clearLayers();
        }
        // ================
        if (this.isDrawer) {
...
var SummaryResultComponent = (function () {
    function SummaryResultComponent(summaryResultService, selectionScaleService, logger) {
        ...
        this.logger = logger;
        this.expandedState = 'collapsed';
        this.round = __WEBPACK_IMPORTED_MODULE_2__shared_data_service__["k" /* round_value */];
        this.scale = 'Nuts 3';
    ...
    SummaryResultComponent.prototype.ngOnChanges = function (changes) {
        ...
        if (this.selectionScaleService.getScaleValue() !== __WEBPACK_IMPORTED_MODULE_2__shared_data_service__["s" /* hectare */]) {
    ...
    SummaryResultComponent.prototype.updateIds = function () {
        var _this = this;
        this.logger.log('SummaryResultComponent/updateIds()');
        this.loadingData = true;
        var payload = { layers: this.layers, year: __WEBPACK_IMPORTED_MODULE_2__shared_data_service__["v" /* constant_year */], nuts: this.nutsIds };
    ...
    SummaryResultComponent.prototype.updateLayers = function () {
        var _this = this;
        this.logger.log('SummaryResultComponent/updateLayers()');
        this.loadingData = true;
        var payload = { layers: this.layers, year: __WEBPACK_IMPORTED_MODULE_2__shared_data_service__["v" /* constant_year */], points: this.locationsSelection };
        var summaryPromise = this.summaryResultService.getSummaryResultWithPayload(payload).then(function (result) {
            _this.summaryResult = result;
        }).then(function () { _this.loadingData = false; }).catch(function (e) {
            _this.logger.log(JSON.stringify(e));
            _this.loadingData = false;
...
var MapComponent = (function () {
    ...
    MapComponent.prototype.createMap = function (basemap) {
        ...
        var self = this;
        this.map = L.map('map', __WEBPACK_IMPORTED_MODULE_1__shared_data_service__["U" /* map_options */]);
...
var MapService = (function (_super) {
    ...
    function MapService(http, logger, loaderService, toasterService, layersService, selectionScaleService, selectionToolService, businessInterfaceRenderService, selectionToolButtonStateService) {
        ...
        _this.zoomlevel = new __WEBPACK_IMPORTED_MODULE_12_rxjs_BehaviorSubject__["BehaviorSubject"](__WEBPACK_IMPORTED_MODULE_2__shared_data_service__["D" /* defaultZoomLevel */]);
    ...
    */
    ...
    MapService.prototype.retriveMapEvent = function () {
        var self = this;
        this.map.on(__WEBPACK_IMPORTED_MODULE_2__shared_data_service__["E" /* MAPCLICK */], function (event) { self.onClickEvent(self, event); });
        this.map.on(__WEBPACK_IMPORTED_MODULE_2__shared_data_service__["F" /* MAPLAYERCHANCE */], function (event) { self.onBaselayerChange(self, event); });
        this.map.on(__WEBPACK_IMPORTED_MODULE_2__shared_data_service__["G" /* MAPZOOMSTART */], function () { self.onZoomStart(self); });
        this.map.on(__WEBPACK_IMPORTED_MODULE_2__shared_data_service__["H" /* MAPZOOMEND */], function () { self.onZoomEnd(self); });
        this.map.on(__WEBPACK_IMPORTED_MODULE_2__shared_data_service__["I" /* MAPLAYERSCONTROLEVENT */], function () { self.onLayersControlEvent(self); });
        this.map.on(__WEBPACK_IMPORTED_MODULE_2__shared_data_service__["J" /* MAPLAYERADD */], function () { self.onLayerAdd(self); });
        this.map.on(__WEBPACK_IMPORTED_MODULE_2__shared_data_service__["K" /* MAPDIDIUPDATELAYER */], function (event) { self.onDidUpdateLayers(self, event); });
        this.map.on(__WEBPACK_IMPORTED_MODULE_2__shared_data_service__["L" /* MAPOVERLAYADD */], function () { self.onOverLayAdd(self); });
        this.map.on(__WEBPACK_IMPORTED_MODULE_2__shared_data_service__["M" /* MAPDRAWCREATED */], function (e) { self.onDrawCreated(self, e); });
        this.map.on(__WEBPACK_IMPORTED_MODULE_2__shared_data_service__["N" /* MAPDRAWEDITED */], function () { self.onDrawEdited(self); });
        this.map.on(__WEBPACK_IMPORTED_MODULE_2__shared_data_service__["O" /* MAPDRAWSTART */], function () { self.onDrawStart(self); });
        this.map.on(__WEBPACK_IMPORTED_MODULE_2__shared_data_service__["P" /* MAPDRAWEDITSTART */], function () { self.onDrawEditStart(self); });
        this.map.on(__WEBPACK_IMPORTED_MODULE_2__shared_data_service__["Q" /* MAPDRAWEDITSTOP */], function () { self.onDrawEditStop(self); });
        this.map.on(__WEBPACK_IMPORTED_MODULE_2__shared_data_service__["R" /* MAPDRAWDELETED */], function () { self.onDrawDeleted(self); });
    };
    // Event functions
    MapService.prototype.onDrawCreated = function (self, e) {
        if (self.selectionScaleService.getScaleValue() === __WEBPACK_IMPORTED_MODULE_2__shared_data_service__["s" /* hectare */]) {
    ...
    MapService.prototype.onClickEvent = function (self, e) {
        ...
        else if (self.selectionScaleService.getScaleValue() === __WEBPACK_IMPORTED_MODULE_2__shared_data_service__["r" /* lau2 */]) {
    ...
    MapService.prototype.getNutsGeometryFromNuts = function (latlng, nuts_level) {
        ...
        var bbox = latlng.toBounds(__WEBPACK_IMPORTED_MODULE_2__shared_data_service__["S" /* clickAccuracy */]).toBBoxString();
        bbox = bbox + '&CQL_FILTER=' + 'stat_levl_=' + current_nuts_level + 'AND ' + 'date=' + '2015' + '-01-01Z';
        var action = 'population';
        var url = __WEBPACK_IMPORTED_MODULE_2__shared_data_service__["T" /* geoserverGetFeatureInfoUrl */]
...
var NutsRenderArray = [
    { id: 0, api_name: '0', business_name: __WEBPACK_IMPORTED_MODULE_0__data_service__["o" /* nuts0 */], suffix: '_nuts0' },
    { id: 1, api_name: '1', business_name: __WEBPACK_IMPORTED_MODULE_0__data_service__["p" /* nuts1 */], suffix: '_nuts1' },
    { id: 2, api_name: '2', business_name: __WEBPACK_IMPORTED_MODULE_0__data_service__["q" /* nuts2 */], suffix: '_nuts2' },
    { id: 3, api_name: '3', business_name: __WEBPACK_IMPORTED_MODULE_0__data_service__["e" /* nuts3 */], suffix: '_nuts3' },
    { id: 4, api_name: '4', business_name: __WEBPACK_IMPORTED_MODULE_0__data_service__["r" /* lau2 */], suffix: '_lau2' },
    { id: 5, api_name: '-1', business_name: __WEBPACK_IMPORTED_MODULE_0__data_service__["s" /* hectare */], suffix: '_ha' },
];
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "l", function() { return geocodeUrl; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "f", function() { return geoserverUrl; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "m", function() { return getIpUrl; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "n", function() { return getLocationFromIp; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return apiUrl; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "u", function() { return defaultLayer; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "w", function() { return idDefaultLayer; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "t", function() { return wwtpLayerName; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "_2", function() { return urlTaigaFeedback; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "_3", function() { return timeOutAjaxRequest; });
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "T", function() { return geoserverGetFeatureInfoUrl; });
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "V", function() { return postPopulationDensityInArea; });
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "_1", function() { return heat_load_api_day; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "Z", function() { return heat_load_api_year; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "_0", function() { return heat_load_api_month; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "Y", function() { return buttons_heat_load; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "c", function() { return timeOut; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "S", function() { return clickAccuracy; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "X", function() { return zoomLevelDetectChange; });
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "A", function() { return business_name_wwtp; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "W", function() { return business_name_population; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "B", function() { return unit_capacity; });
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "k", function() { return round_value; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "D", function() { return defaultZoomLevel; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "U", function() { return map_options; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "h", function() { return lau2name; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "o", function() { return nuts0; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "p", function() { return nuts1; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "q", function() { return nuts2; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "e", function() { return nuts3; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "r", function() { return lau2; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "s", function() { return hectare; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "d", function() { return initial_scale_value; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "N", function() { return MAPDRAWEDITED; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "O", function() { return MAPDRAWSTART; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "R", function() { return MAPDRAWDELETED; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "Q", function() { return MAPDRAWEDITSTOP; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "P", function() { return MAPDRAWEDITSTART; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "M", function() { return MAPDRAWCREATED; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "E", function() { return MAPCLICK; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "F", function() { return MAPLAYERCHANCE; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "G", function() { return MAPZOOMSTART; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "H", function() { return MAPZOOMEND; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "I", function() { return MAPLAYERSCONTROLEVENT; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "J", function() { return MAPLAYERADD; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "K", function() { return MAPDIDIUPDATELAYER; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "L", function() { return MAPOVERLAYADD; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "_5", function() { return rightPanelSize; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "_4", function() { return leftPanelSize; });
...
var Helper = (function () {
    ...
    Helper.prototype.round = function (num) {
        ...
        ;
        return this.decimalPipe.transform(num, __WEBPACK_IMPORTED_MODULE_3__data_service__["k" /* round_value */]);
    };
...
/* harmony namespace reexport (by used) */ __webpack_require__.d(__webpack_exports__, "hectare", function() { return __WEBPACK_IMPORTED_MODULE_4__data_service__["s"]; });
/* harmony namespace reexport (by used) */ __webpack_require__.d(__webpack_exports__, "buttons_heat_load", function() { return __WEBPACK_IMPORTED_MODULE_4__data_service__["Y"]; });
/* harmony namespace reexport (by used) */ __webpack_require__.d(__webpack_exports__, "heat_load_api_year", function() { return __WEBPACK_IMPORTED_MODULE_4__data_service__["Z"]; });
/* harmony namespace reexport (by used) */ __webpack_require__.d(__webpack_exports__, "heat_load_api_month", function() { return __WEBPACK_IMPORTED_MODULE_4__data_service__["_0"]; });
/* harmony namespace reexport (by used) */ __webpack_require__.d(__webpack_exports__, "heat_load_api_day", function() { return __WEBPACK_IMPORTED_MODULE_4__data_service__["_1"]; });
/* harmony namespace reexport (by used) */ __webpack_require__.d(__webpack_exports__, "timeOutAjaxRequest", function() { return __WEBPACK_IMPORTED_MODULE_4__data_service__["_3"]; });
/* harmony namespace reexport (by used) */ __webpack_require__.d(__webpack_exports__, "leftPanelSize", function() { return __WEBPACK_IMPORTED_MODULE_4__data_service__["_4"]; });
/* harmony namespace reexport (by used) */ __webpack_require__.d(__webpack_exports__, "rightPanelSize", function() { return __WEBPACK_IMPORTED_MODULE_4__data_service__["_5"]; });
...
var GeocodingService = (function () {
    ...
    GeocodingService.prototype.geocode = function (address) {
        ...
        this.loaderService.display(true);
        return this.http
            .get(__WEBPACK_IMPORTED_MODULE_7__data_service__["l" /* geocodeUrl */] + encodeURIComponent(address))
    ...
    GeocodingService.prototype.getCurrentLocation = function () {
        ...
        // this.loaderService.display(true);
        return this.http
            .get(__WEBPACK_IMPORTED_MODULE_7__data_service__["m" /* getIpUrl */])
            .map(function (res) { return res.json().ip; })
            .flatMap(function (ip) { return _this.http.get(__WEBPACK_IMPORTED_MODULE_7__data_service__["n" /* getLocationFromIp */] + ip); })
            .map(function (res) { return res.json(); })
            .map(function (result) {
            var location = new __WEBPACK_IMPORTED_MODULE_1__class_location_location_class__["a" /* LocationClass */]();
