...
var LayersService = (function (_super) {
    ...
    function LayersService(http, logger, loaderService, toasterService, 
        ...
        _this.layersArray = new __WEBPACK_IMPORTED_MODULE_0__shared_class_dictionary_class__["a" /* Dictionary */]([
            {
                key: __WEBPACK_IMPORTED_MODULE_8__shared_data_service__["B" /* defaultLayer */], value: _this.getTilayer(_this.heatmapOption, _this.loaderService)
            },
        ]);
        _this.popup = L.popup();
        return _this;
    ...
    LayersService.prototype.setupDefaultLayer = function () {
        var layer = this.layersArray.value(__WEBPACK_IMPORTED_MODULE_8__shared_data_service__["B" /* defaultLayer */]);
...
var MapComponent = (function () {
    ...
    MapComponent.prototype.createMap = function (basemap) {
        ...
        var self = this;
        this.map = L.map('map', __WEBPACK_IMPORTED_MODULE_1__shared_data_service__["_16" /* map_options */]);
...
var MapService = (function (_super) {
    ...
    function MapService(http, logger, loaderService, toasterService, layersService, selectionScaleService, cmLayerService, selectionToolService, helper, businessInterfaceRenderService, selectionToolButtonStateService) {
        ...
        _this.zoomlevel = new __WEBPACK_IMPORTED_MODULE_13_rxjs_BehaviorSubject__["BehaviorSubject"](__WEBPACK_IMPORTED_MODULE_3__shared_data_service__["Z" /* defaultZoomLevel */]);
    ...
    */
    ...
    MapService.prototype.retriveMapEvent = function () {
        var self = this;
        this.map.on(__WEBPACK_IMPORTED_MODULE_3__shared_data_service__["_0" /* MAPCLICK */], function (event) { self.onClickEvent(self, event); });
        this.map.on(__WEBPACK_IMPORTED_MODULE_3__shared_data_service__["_1" /* MAPLAYERCHANCE */], function (event) { self.onBaselayerChange(self, event); });
        this.map.on(__WEBPACK_IMPORTED_MODULE_3__shared_data_service__["_2" /* MAPZOOMSTART */], function () { self.onZoomStart(self); });
        this.map.on(__WEBPACK_IMPORTED_MODULE_3__shared_data_service__["_3" /* MAPZOOMEND */], function () { self.onZoomEnd(self); });
        this.map.on(__WEBPACK_IMPORTED_MODULE_3__shared_data_service__["_4" /* MAPLAYERSCONTROLEVENT */], function () { self.onLayersControlEvent(self); });
        this.map.on(__WEBPACK_IMPORTED_MODULE_3__shared_data_service__["_5" /* MAPLAYERADD */], function (e) { self.onLayerAdd(self, e); });
        this.map.on(__WEBPACK_IMPORTED_MODULE_3__shared_data_service__["_6" /* MAPDIDIUPDATELAYER */], function (event) { self.onDidUpdateLayers(self, event); });
        this.map.on(__WEBPACK_IMPORTED_MODULE_3__shared_data_service__["_7" /* MAPOVERLAYADD */], function () { self.onOverLayAdd(self); });
        this.map.on(__WEBPACK_IMPORTED_MODULE_3__shared_data_service__["_8" /* MAPDRAWCREATED */], function (e) { self.onDrawCreated(self, e); });
        this.map.on(__WEBPACK_IMPORTED_MODULE_3__shared_data_service__["_9" /* MAPDRAWEDITED */], function () { self.onDrawEdited(self); });
        this.map.on(__WEBPACK_IMPORTED_MODULE_3__shared_data_service__["_10" /* MAPDRAWSTART */], function () { self.onDrawStart(self); });
        this.map.on(__WEBPACK_IMPORTED_MODULE_3__shared_data_service__["_11" /* MAPDRAWEDITSTART */], function () { self.onDrawEditStart(self); });
        this.map.on(__WEBPACK_IMPORTED_MODULE_3__shared_data_service__["_12" /* MAPDRAWEDITSTOP */], function (e) { self.onDrawEditStop(self, e); });
        this.map.on(__WEBPACK_IMPORTED_MODULE_3__shared_data_service__["_13" /* MAPDRAWDELETED */], function () { self.onDrawDeleted(self); });
    };
    // Event functions
...
var NutsRenderArray = [
    ...
    { id: 3, api_name: '3', business_name: __WEBPACK_IMPORTED_MODULE_0__data_service__["x" /* nuts3 */], suffix: '_nuts3' },
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "B", function() { return defaultLayer; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "C", function() { return styleNameHeat; });
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "_12", function() { return MAPDRAWEDITSTOP; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "_11", function() { return MAPDRAWEDITSTART; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "_8", function() { return MAPDRAWCREATED; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "_0", function() { return MAPCLICK; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "_1", function() { return MAPLAYERCHANCE; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "_2", function() { return MAPZOOMSTART; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "_3", function() { return MAPZOOMEND; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "_4", function() { return MAPLAYERSCONTROLEVENT; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "_5", function() { return MAPLAYERADD; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "_6", function() { return MAPDIDIUPDATELAYER; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "_7", function() { return MAPOVERLAYADD; });
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__toaster_service__ = __webpack_require__("../../../../../src/app/shared/services/toaster.service.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__angular_core__ = __webpack_require__("../../../core/@angular/core.es5.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__features_summary_result_summary_result_service__ = __webpack_require__("../../../../../src/app/features/summary-result/summary-result.service.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__pages_nav_service_navigation_bar_service__ = __webpack_require__("../../../../../src/app/pages/nav/service/navigation-bar.service.ts");
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__features_side_panel_side_panel_service__ = __webpack_require__("../../../../../src/app/features/side-panel/side-panel.service.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6_app_features_layers__ = __webpack_require__("../../../../../src/app/features/layers/index.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__features_graph_heat_load_heat_load_service__ = __webpack_require__("../../../../../src/app/features/graph/heat-load/heat-load.service.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__features_export_data_service_export_data_service__ = __webpack_require__("../../../../../src/app/features/export-data/service/export-data.service.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__features_graph_duration_curve_duration_curve_service__ = __webpack_require__("../../../../../src/app/features/graph/duration-curve/duration-curve.service.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_10__features_layers_interaction_layers_interaction_service__ = __webpack_require__("../../../../../src/app/features/layers-interaction/layers-interaction.service.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_11__features_graph_electricity_mix_service_electricity_mix_service__ = __webpack_require__("../../../../../src/app/features/graph/electricity-mix/service/electricity-mix.service.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_12__features_calculation_module_service_calculation_test_service__ = __webpack_require__("../../../../../src/app/features/calculation-module/service/calculation-test.service.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_13__features_calculation_module_service_calculation_module_service__ = __webpack_require__("../../../../../src/app/features/calculation-module/service/calculation-module.service.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_14_app_features_calculation_module_service_calcultation_module_status_service__ = __webpack_require__("../../../../../src/app/features/calculation-module/service/calcultation-module-status.service.ts");
...
InteractionService = __decorate([
    __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_1__angular_core__["Injectable"])(),
    __metadata("design:paramtypes", [typeof (_a = typeof __WEBPACK_IMPORTED_MODULE_4__logger_service__["a" /* Logger */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_4__logger_service__["a" /* Logger */]) === "function" && _a || Object, typeof (_b = typeof __WEBPACK_IMPORTED_MODULE_5__features_side_panel_side_panel_service__["a" /* SidePanelService */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_5__features_side_panel_side_panel_service__["a" /* SidePanelService */]) === "function" && _b || Object, typeof (_c = typeof __WEBPACK_IMPORTED_MODULE_0__toaster_service__["a" /* ToasterService */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_0__toaster_service__["a" /* ToasterService */]) === "function" && _c || Object, typeof (_d = typeof __WEBPACK_IMPORTED_MODULE_3__pages_nav_service_navigation_bar_service__["a" /* NavigationBarService */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_3__pages_nav_service_navigation_bar_service__["a" /* NavigationBarService */]) === "function" && _d || Object, typeof (_e = typeof __WEBPACK_IMPORTED_MODULE_2__features_summary_result_summary_result_service__["a" /* SummaryResultService */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_2__features_summary_result_summary_result_service__["a" /* SummaryResultService */]) === "function" && _e || Object, typeof (_f = typeof __WEBPACK_IMPORTED_MODULE_6_app_features_layers__["LayersService"] !== "undefined" && __WEBPACK_IMPORTED_MODULE_6_app_features_layers__["LayersService"]) === "function" && _f || Object, typeof (_g = typeof __WEBPACK_IMPORTED_MODULE_8__features_export_data_service_export_data_service__["a" /* ExportDataService */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_8__features_export_data_service_export_data_service__["a" /* ExportDataService */]) === "function" && _g || Object, typeof (_h = typeof __WEBPACK_IMPORTED_MODULE_7__features_graph_heat_load_heat_load_service__["a" /* HeatLoadAggregateService */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_7__features_graph_heat_load_heat_load_service__["a" /* HeatLoadAggregateService */]) === "function" && _h || Object, typeof (_j = typeof __WEBPACK_IMPORTED_MODULE_9__features_graph_duration_curve_duration_curve_service__["a" /* DurationCurveService */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_9__features_graph_duration_curve_duration_curve_service__["a" /* DurationCurveService */]) === "function" && _j || Object, typeof (_k = typeof __WEBPACK_IMPORTED_MODULE_10__features_layers_interaction_layers_interaction_service__["a" /* DataInteractionService */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_10__features_layers_interaction_layers_interaction_service__["a" /* DataInteractionService */]) === "function" && _k || Object, typeof (_l = typeof __WEBPACK_IMPORTED_MODULE_11__features_graph_electricity_mix_service_electricity_mix_service__["a" /* ElectricityMixService */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_11__features_graph_electricity_mix_service_electricity_mix_service__["a" /* ElectricityMixService */]) === "function" && _l || Object, typeof (_m = typeof __WEBPACK_IMPORTED_MODULE_14_app_features_calculation_module_service_calcultation_module_status_service__["a" /* CalculationModuleStatusService */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_14_app_features_calculation_module_service_calcultation_module_status_service__["a" /* CalculationModuleStatusService */]) === "function" && _m || Object, typeof (_o = typeof __WEBPACK_IMPORTED_MODULE_13__features_calculation_module_service_calculation_module_service__["a" /* CalculationModuleService */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_13__features_calculation_module_service_calculation_module_service__["a" /* CalculationModuleService */]) === "function" && _o || Object, typeof (_p = typeof __WEBPACK_IMPORTED_MODULE_12__features_calculation_module_service_calculation_test_service__["a" /* CalculationHeatLoadDividedService */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_12__features_calculation_module_service_calculation_test_service__["a" /* CalculationHeatLoadDividedService */]) === "function" && _p || Object])
], InteractionService);
