...
module.exports = "\n<div *ngIf=\"expanded\" [@visibleTrigger]=\"'visible'\" class=\"details\">\n\n    <div class=\"message\">\n      <input type=\"checkbox\" name={{dataInteraction.name}} [checked]=\"dataInteraction.isSelected\" (change)=\"showRemoveLayer($event,dataInteraction.name)\"> <span>{{dataInteraction.name}}</span>\n    </div>\n\n</div>\n"
...
var DataInteractionArray = [
    ...
    { id: 12, name: 'wwtp', category: 'Comsumption', isSelected: false },
];
...
var LayersService = (function (_super) {
    ...
    LayersService.prototype.getDetailLayerPoint = function (action, latlng, map) {
        var _this = this;
        if (this.wwtpPoints) {
            var bbox = latlng.toBounds(__WEBPACK_IMPORTED_MODULE_4__shared_data_service__["a" /* clickAccuracy */]).toBBoxString();
            ...
            return this.http.get(url).map(function (res) { return res.json(); })
                .subscribe(function (res) { return _this.addPopup(map, res, latlng); }, function (err) { return _this.handleError.bind(_this); });
        }
    };
    LayersService.prototype.addLayerWithAction = function (action, map) {
        if (this.wwtpPoints) {
            ...
            this.wwtpPoints = L.tileLayer.wms(__WEBPACK_IMPORTED_MODULE_4__shared_data_service__["b" /* geoserverUrl */], {
    ...
    LayersService.prototype.removeWWTPlayer = function (map) {
        if (this.wwtpPoints) {
...
var PopulationService = (function (_super) {
    ...
    PopulationService.prototype.getPopulationWithPayloads = function (payload) {
        return _super.prototype.POST.call(this, payload, __WEBPACK_IMPORTED_MODULE_4__shared_data_service__["f" /* apiUrl */] + __WEBPACK_IMPORTED_MODULE_4__shared_data_service__["g" /* postPopulationDensityInArea */]);
    };
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "f", function() { return apiUrl; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "g", function() { return postPopulationDensityInArea; });
...
var MapService = (function () {
    ...
    MapService.prototype.addLayerWithAction = function (action) {
    ...
    MapService.prototype.showWWTp = function (geometrie) {
