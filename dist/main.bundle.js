...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_51__features_layer_tool_layer_tool_component__ = __webpack_require__("../../../../../src/app/features/layer-tool/layer-tool.component.ts");
...
AppModule = __decorate([
    __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_3__angular_core__["NgModule"])({
        ...
        declarations: [
            ...
            __WEBPACK_IMPORTED_MODULE_51__features_layer_tool_layer_tool_component__["a" /* LayerToolComponent */]
        ],
        providers: [
...
var CalculationModuleComponent = (function () {
    function CalculationModuleComponent(calculationModuleService, calculationModuleStatusService, dataInteractionService, helper, logger, toasterService) {
        ...
        this.inputs_categories = __WEBPACK_IMPORTED_MODULE_0__shared_data_service__["_9" /* inputs_categories */];
        this.progress = 0;
...
var CalculationModuleService = (function (_super) {
    ...
    CalculationModuleService.prototype.getMockCalculationModuleComponents = function (id) {
        return Promise.resolve(__WEBPACK_IMPORTED_MODULE_0__component_mock_calculation_data__["b" /* mockComponents */]);
    };
...
var ExportDataComponent = (function () {
    function ExportDataComponent(exportDataService, logger, helper) {
        ...
        this.tabsSelectedName = __WEBPACK_IMPORTED_MODULE_4__shared_data_service__["C" /* tab1_datapanel */];
    ...
    ExportDataComponent.prototype.export = function () {
        if (this.tabSelected === __WEBPACK_IMPORTED_MODULE_4__shared_data_service__["C" /* tab1_datapanel */]) {
        ...
        else if (this.tabSelected === __WEBPACK_IMPORTED_MODULE_4__shared_data_service__["_11" /* tab2_datapanel */]) {
...
var FeedbackComponent = (function () {
    ...
    FeedbackComponent.prototype.sendRequest = function (f) {
        ...
        jQuery.ajax({
            url: __WEBPACK_IMPORTED_MODULE_5__shared_data_service__["_20" /* urlTaigaFeedback */],
            type: 'POST',
            data: fd,
            processData: false,
            contentType: false,
...
var DurationCurveComponent = (function () {
    ...
    DurationCurveComponent.prototype.update = function () {
        ...
        if (this.scaleLevel === '-1') {
            isHectare = true;
            payload = this.helper.createDCPayloadHectares(__WEBPACK_IMPORTED_MODULE_4__shared_data_service__["_12" /* constant_year_duration_curve */], this.durationCurvePayload.areas);
        }
        else {
            payload = this.helper.createDCPayloadNuts(__WEBPACK_IMPORTED_MODULE_4__shared_data_service__["_12" /* constant_year_duration_curve */], this.durationCurvePayload.nuts);
        }
        ...
        this.interactionService.getDurationCurveWithPayload(payload, isHectare).then(function (result) {
            ...
            _this.options = __WEBPACK_IMPORTED_MODULE_4__shared_data_service__["_13" /* duration_curve_graph_options */];
        }).then(function () {
...
var DurationCurveService = (function (_super) {
    ...
    DurationCurveService.prototype.getDurationCurveWithPayload = function (payload, isHectare) {
        if (isHectare === false) {
            ...
            return _super.prototype.POST.call(this, payload, __WEBPACK_IMPORTED_MODULE_8__shared_data_service__["b" /* apiUrl */] + __WEBPACK_IMPORTED_MODULE_8__shared_data_service__["A" /* postDurationCurveNutsLau */]);
        }
        else {
            this.logger.log('DurationCurveService/getDurationCurveWithPayload = ' + JSON.stringify(payload));
            return _super.prototype.POST.call(this, payload, __WEBPACK_IMPORTED_MODULE_8__shared_data_service__["b" /* apiUrl */] + __WEBPACK_IMPORTED_MODULE_8__shared_data_service__["B" /* postDurationCurveHectares */]);
        }
    };
...
var ElectricityMixComponent = (function () {
    ...
    ElectricityMixComponent.prototype.ngOnInit = function () {
        this.options = __WEBPACK_IMPORTED_MODULE_3__shared_data_service__["_10" /* energy_mix_options */];
        /* this.update(); */
    };
...
var ElectricityMixService = (function (_super) {
    ...
    ElectricityMixService.prototype.getElectricityMix = function (payload) {
        this.logger.log(__WEBPACK_IMPORTED_MODULE_7_app_shared_data_service__["b" /* apiUrl */] + __WEBPACK_IMPORTED_MODULE_7_app_shared_data_service__["y" /* postHeatLoadProfileHectares */]);
        return _super.prototype.POST.call(this, payload, __WEBPACK_IMPORTED_MODULE_7_app_shared_data_service__["b" /* apiUrl */] + __WEBPACK_IMPORTED_MODULE_7_app_shared_data_service__["z" /* getElectricityMixFromNuts0 */]);
    };
    ...
    HeatLoadChartComponent.prototype.update = function () {
        ...
        if (this.buttons_date_type !== undefined) {
            ...
            this.interactionService.getHeatLoad(payload, this.selectedButton.api_ref, isHectare).then(function (result) {
                ...
                _this.options = __WEBPACK_IMPORTED_MODULE_3__shared_data_service__["_14" /* heat_load_graph_options */];
...
var HeatLoadAggregateService = (function (_super) {
    ...
    HeatLoadAggregateService.prototype.getHeatLoad = function (payload, type_api_ref, isHectare) {
        if (isHectare === false) {
            this.logger.log('postHeatLoadProfileNutsLau ' + __WEBPACK_IMPORTED_MODULE_8__shared_data_service__["b" /* apiUrl */] + __WEBPACK_IMPORTED_MODULE_8__shared_data_service__["D" /* postHeatLoadProfileNutsLau */] + '/' + type_api_ref);
            return _super.prototype.POST.call(this, payload, __WEBPACK_IMPORTED_MODULE_8__shared_data_service__["b" /* apiUrl */] + __WEBPACK_IMPORTED_MODULE_8__shared_data_service__["D" /* postHeatLoadProfileNutsLau */]);
        }
        else {
            this.logger.log('postHeatLoadProfileHectares ' + __WEBPACK_IMPORTED_MODULE_8__shared_data_service__["b" /* apiUrl */] + __WEBPACK_IMPORTED_MODULE_8__shared_data_service__["y" /* postHeatLoadProfileHectares */] + type_api_ref);
            this.logger.log(__WEBPACK_IMPORTED_MODULE_8__shared_data_service__["b" /* apiUrl */] + __WEBPACK_IMPORTED_MODULE_8__shared_data_service__["y" /* postHeatLoadProfileHectares */]);
            return _super.prototype.POST.call(this, payload, __WEBPACK_IMPORTED_MODULE_8__shared_data_service__["b" /* apiUrl */] + __WEBPACK_IMPORTED_MODULE_8__shared_data_service__["y" /* postHeatLoadProfileHectares */]);
        }
    };
...
var DataInteractionCellComponent = (function () {
    function DataInteractionCellComponent(mapService, interactionService) {
        ...
        this.interactionService = interactionService;
        this.loading = true;
        this.cm_cat = __WEBPACK_IMPORTED_MODULE_0__shared_data_service__["x" /* calculation_module_category */];
    }
    ...
    DataInteractionCellComponent.prototype.showRemoveLayer = function (e) {
        ...
        if (this.interactionService.getSummaryResultState() === false) {
            ...
            if (this.dataInteraction.category === __WEBPACK_IMPORTED_MODULE_0__shared_data_service__["x" /* calculation_module_category */]) {
...
var DataInteractionArray = [
    ...
    { id: __WEBPACK_IMPORTED_MODULE_0__shared_data_service__["q" /* idDefaultLayer */], name: 'Heat density total', category: 'Buildings', isSelected: true,
        workspaceName: __WEBPACK_IMPORTED_MODULE_0__shared_data_service__["r" /* defaultLayer */], zoomLevel: 0, ref: ['overall', 'demand'], styleName: __WEBPACK_IMPORTED_MODULE_1__shared_data_service__["s" /* styleNameHeat */], layer_type: __WEBPACK_IMPORTED_MODULE_0__shared_data_service__["t" /* defaultLayerType */],
    ...
    { id: 12, name: __WEBPACK_IMPORTED_MODULE_0__shared_data_service__["u" /* business_name_wwtp */] + ' Power', category: 'R.E.S. Potential', isSelected: false,
        workspaceName: 'wwtp_power', zoomLevel: __WEBPACK_IMPORTED_MODULE_1__shared_data_service__["v" /* zoomLevelDetectChange */], ref: ['overall', 'potential'],
        styleName: __WEBPACK_IMPORTED_MODULE_1__shared_data_service__["s" /* styleNameHeat */], layer_type: 'wwtp_power' },
    { id: 12, name: __WEBPACK_IMPORTED_MODULE_0__shared_data_service__["u" /* business_name_wwtp */] + ' Capacity', category: 'R.E.S. Potential', isSelected: false,
        workspaceName: 'wwtp_capacity', zoomLevel: __WEBPACK_IMPORTED_MODULE_1__shared_data_service__["v" /* zoomLevelDetectChange */], ref: ['overall', 'potential'],
        styleName: __WEBPACK_IMPORTED_MODULE_1__shared_data_service__["s" /* styleNameHeat */], layer_type: 'wwtp_capacity' },
    ...
    { id: 14, name: 'Population total', category: 'Population', isSelected: false,
        workspaceName: __WEBPACK_IMPORTED_MODULE_0__shared_data_service__["w" /* populationLayerName */], zoomLevel: 0, ref: ['overall', 'demand'],
    ...
    { id: 20, name: 'Solar potential', category: 'R.E.S. Potential', isSelected: false,
        workspaceName: 'solar_optimal_total', zoomLevel: 0, ref: ['overall', 'potential'], styleName: __WEBPACK_IMPORTED_MODULE_1__shared_data_service__["s" /* styleNameHeat */], layer_type: 'solar_optimal_total' },
...
var cm_default_layer = {
    id: 21, name: '',
    category: __WEBPACK_IMPORTED_MODULE_0__shared_data_service__["x" /* calculation_module_category */],
    isSelected: true,
    workspaceName: '',
    zoomLevel: 0, ref: ['overall', __WEBPACK_IMPORTED_MODULE_0__shared_data_service__["x" /* calculation_module_category */]],
    styleName: '',
    layer_type: __WEBPACK_IMPORTED_MODULE_0__shared_data_service__["x" /* calculation_module_category */],
    cm_id: ''
};
...
var LayersService = (function (_super) {
    ...
    function LayersService(http, logger, loaderService, toasterService, 
        ...
        _this.heatmapOption = {
            ...
            format: __WEBPACK_IMPORTED_MODULE_8__shared_data_service__["G" /* formatImage */], transparent: true, version: '1.3.0',
            zIndex: __WEBPACK_IMPORTED_MODULE_8__shared_data_service__["q" /* idDefaultLayer */]
        };
        _this.layersArray = new __WEBPACK_IMPORTED_MODULE_0__shared_class_dictionary_class__["a" /* Dictionary */]([
            {
                key: __WEBPACK_IMPORTED_MODULE_8__shared_data_service__["r" /* defaultLayer */], value: _this.getTilayer(_this.heatmapOption, _this.loaderService)
            },
        ]);
        _this.popup = L.popup();
        return _this;
    ...
    LayersService.prototype.addLayerWithAction = function (action, map, order) {
        ...
        var option = {
            ...
            format: __WEBPACK_IMPORTED_MODULE_8__shared_data_service__["G" /* formatImage */],
            transparent: true,
            version: '1.3.0',
            srs: 'EPSG:4326',
            zIndex: 1
    ...
    LayersService.prototype.getTilayer = function (option, loader) {
        var wms_request = L.tileLayer.wms(__WEBPACK_IMPORTED_MODULE_8__shared_data_service__["F" /* geoserverUrl */], option);
    ...
    LayersService.prototype.choosePopup = function (map, res, latlng, action) {
        ...
        else if (action === __WEBPACK_IMPORTED_MODULE_8__shared_data_service__["K" /* wwtpLayerName */]) {
            this.addPopupWWTP(map, res, latlng);
        }
        else if (action === __WEBPACK_IMPORTED_MODULE_8__shared_data_service__["w" /* populationLayerName */] + '_' + __WEBPACK_IMPORTED_MODULE_8__shared_data_service__["L" /* constant_year */]) {
    ...
    LayersService.prototype.addPopupHectare = function (map, data, latlng) {
        ...
        this.popup.setLatLng(latlng)
            ...
            ' <li>Population density: ' + this.helper.round(population_density) + ' ' + __WEBPACK_IMPORTED_MODULE_8__shared_data_service__["M" /* unit_population */] + '</li> </ul>')
            .openOn(map);
    };
    LayersService.prototype.addPopupHeatmap = function (map, data, latlng) {
        ...
        this.popup.setLatLng(latlng)
            ...
            ' <li>Heat demand: ' + this.helper.round(heat_density) + ' ' + __WEBPACK_IMPORTED_MODULE_8__shared_data_service__["N" /* unit_heat_density */] + '</li> </ul>')
            .openOn(map);
    };
    LayersService.prototype.addPopupWWTP = function (map, data, latlng) {
        ...
        this.popup.setLatLng(latlng).setContent('<h5>' + __WEBPACK_IMPORTED_MODULE_8__shared_data_service__["u" /* business_name_wwtp */] + '</h5> <ul class="uk-list uk-list-divider">' +
            '<li>Capacity: ' + capacity + ' ' + __WEBPACK_IMPORTED_MODULE_8__shared_data_service__["O" /* unit_capacity */] + '</li><li>Power: ' + this.helper.round(power) + ' ' + unit + '</li>' +
    ...
    LayersService.prototype.showWwtpWithMarker = function (map) {
        ...
        var url = __WEBPACK_IMPORTED_MODULE_8__shared_data_service__["F" /* geoserverUrl */] + '?service=wfs' +
            '&version=2.0.0' +
            '&request=GetFeature' +
            '&typeNames=hotmaps:' + __WEBPACK_IMPORTED_MODULE_8__shared_data_service__["K" /* wwtpLayerName */] +
            '&srsName=EPSG:' + epsg +
...
var PopulationService = (function (_super) {
    ...
    */
    PopulationService.prototype.addPopupNuts = function (data, map, latlng, popup) {
        ...
        popup.setLatLng(latlng).setContent('<h5>' + __WEBPACK_IMPORTED_MODULE_4__shared_data_service__["_7" /* business_name_population */] + '</h5> <ul class="uk-list uk-list-divider">' +
            '<li>nuts id: ' + nuts_id + '</li><li>nuts level: ' + stat_levl_ + '</li><li>name: ' + name + '</li>' +
            '<li>Population: ' + this.helper.round(value) + ' ' + __WEBPACK_IMPORTED_MODULE_4__shared_data_service__["M" /* unit_population */] + '</li><li>Reference date: ' + date + '</li></ul>').openOn(map);
...
var ResultManagerComponent = (function () {
    function ResultManagerComponent(helper, interactionService, logger, dataInteractionService, mapService) {
        ...
        this.tab1 = __WEBPACK_IMPORTED_MODULE_0__shared_data_service__["C" /* tab1_datapanel */];
        this.tab2 = __WEBPACK_IMPORTED_MODULE_0__shared_data_service__["_11" /* tab2_datapanel */];
        this.cm_catedory = __WEBPACK_IMPORTED_MODULE_0__shared_data_service__["x" /* calculation_module_category */];
    ...
    ResultManagerComponent.prototype.updateEnergyMixResult = function () {
        var self = this;
        var graphic = self.addGraphic(__WEBPACK_IMPORTED_MODULE_0__shared_data_service__["_22" /* energy_mix_title */], 'pie', [], [], __WEBPACK_IMPORTED_MODULE_0__shared_data_service__["_10" /* energy_mix_options */], __WEBPACK_IMPORTED_MODULE_0__shared_data_service__["_23" /* energy_mix_graph_category */], true);
    ...
    ResultManagerComponent.prototype.updateHeatLoadResult = function () {
        this.heatloadGraph = this.addGraphic(__WEBPACK_IMPORTED_MODULE_0__shared_data_service__["_15" /* heatloadprofile */], 'line', [], [], __WEBPACK_IMPORTED_MODULE_0__shared_data_service__["_14" /* heat_load_graph_options */], 'heatload', true);
    };
    ResultManagerComponent.prototype.updateDurationCurveResult = function () {
        var _this = this;
        var self = this;
        var graphic = self.addGraphic(__WEBPACK_IMPORTED_MODULE_0__shared_data_service__["_24" /* duration_curve_graph_title */], 'line', [], [], __WEBPACK_IMPORTED_MODULE_0__shared_data_service__["_13" /* duration_curve_graph_options */], __WEBPACK_IMPORTED_MODULE_0__shared_data_service__["_25" /* duration_curve_graph_category */], true);
        var isHectare;
        if (this.scaleLevel === '-1') {
            isHectare = true;
        }
            ...
            if (response["state"] === 'SUCCESS') {
                ...
                if (response.status.result.indicator.length >= 1) {
                    _this.result.indicators.layers.push({
                        name: response.status.result.name, values: response.status.result.indicator, category: ['overall', __WEBPACK_IMPORTED_MODULE_0__shared_data_service__["x" /* calculation_module_category */]]
                    });
                ...
                if (response.status.result.graphics.length >= 1) {
                    response.status.result.graphics.map(function (graphic) {
                        ...
                        var graph = _this.addGraphic(response.status.result.name, graphic.type, graphic.data.datasets, graphic.data.labels, option_calculation_module, __WEBPACK_IMPORTED_MODULE_0__shared_data_service__["x" /* calculation_module_category */], false);
                    });
                    _this.displayExportDataStatus = true;
                }
...
var hectareOption = {
    ...
    format: __WEBPACK_IMPORTED_MODULE_0__shared_data_service__["G" /* formatImage */],
    transparent: true,
    version: '1.3.0',
...
var lau2LayerOption = {
    layers: 'hotmaps:' + __WEBPACK_IMPORTED_MODULE_0__shared_data_service__["H" /* lau2name */],
    format: __WEBPACK_IMPORTED_MODULE_0__shared_data_service__["G" /* formatImage */],
    transparent: true,
    version: '1.3.0',
    zIndex: 99
...
var SelectionScaleService = (function (_super) {
    ...
    function SelectionScaleService(http, logger, loaderService, toasterService) {
        var _this = _super.call(this, http, logger, loaderService, toasterService) || this;
        _this.scaleValue = __WEBPACK_IMPORTED_MODULE_8__shared_data_service__["E" /* initial_scale_value */];
        // scale value subject
    ...
    SelectionScaleService.prototype.getSelectionScaleMenu = function (map, loader) {
        ...
        control.addTo(map);
        map.addLayer(SelectionScale[__WEBPACK_IMPORTED_MODULE_8__shared_data_service__["E" /* initial_scale_value */]]); // # Add this if you want to show, comment this if you want to hide it.-
    };
    ...
    SelectionScaleService.prototype.getInitialScale = function () {
        return __WEBPACK_IMPORTED_MODULE_8__shared_data_service__["E" /* initial_scale_value */];
    };
...
var SelectionToolService = (function (_super) {
    ...
    function SelectionToolService(http, logger, loaderService, toasterService, helper, businessInterfaceRenderService, interactionService, selectionToolUtils) {
        ...
        _this.scaleValue = __WEBPACK_IMPORTED_MODULE_3__shared_data_service__["E" /* initial_scale_value */];
...
var LeftSideComponent = (function (_super) {
        ...
        if (!this.helper.isNullOrUndefined(this.mapService.getNutsSelectedSubject())) {
            this.mapService.getNutsSelectedSubject().subscribe(function (value) {
                ...
                if (value === 0) {
                    ...
                    if (_this.scaleLevel === __WEBPACK_IMPORTED_MODULE_11__shared_data_service__["p" /* hectare */]) {
    ...
    LeftSideComponent.prototype.getLayerAndCategory = function (layers) {
        ...
        this.category.push(__WEBPACK_IMPORTED_MODULE_0__shared_data_service__["x" /* calculation_module_category */]);
    };
...
var RightSideComponent = (function (_super) {
    ...
    RightSideComponent.prototype.setSummaryPayloadIds = function () {
        var payload = { layers: this.layers, year: __WEBPACK_IMPORTED_MODULE_6__shared_data_service__["L" /* constant_year */], nuts: this.nutsIds };
    ...
    RightSideComponent.prototype.setSummaryPayloadArea = function () {
        ...
        this.summaryPayload = { layers: this.layers, year: __WEBPACK_IMPORTED_MODULE_6__shared_data_service__["L" /* constant_year */], areas: areas };
    };
    ...
    RightSideComponent.prototype.setDurationCurveIds = function () {
        this.durationCurvePayload = { nuts: this.nutsIds, year: __WEBPACK_IMPORTED_MODULE_6__shared_data_service__["_12" /* constant_year_duration_curve */] };
    };
    RightSideComponent.prototype.setDurationCurveAreas = function () {
        this.durationCurvePayload = { areas: this.helper.getAreasForPayload(this.areas), year: __WEBPACK_IMPORTED_MODULE_6__shared_data_service__["_12" /* constant_year_duration_curve */] };
    };
...
var SummaryResultService = (function (_super) {
    ...
    SummaryResultService.prototype.getSummaryResultWithIds = function (payload) {
        ...
        return _super.prototype.POST.call(this, payload, __WEBPACK_IMPORTED_MODULE_7__shared_data_service__["b" /* apiUrl */] + __WEBPACK_IMPORTED_MODULE_7__shared_data_service__["I" /* postStatsLayersNutsLau */]);
    };
    SummaryResultService.prototype.getSummaryResultWithMultiAreas = function (payload) {
        ...
        return _super.prototype.POST.call(this, payload, __WEBPACK_IMPORTED_MODULE_7__shared_data_service__["b" /* apiUrl */] + __WEBPACK_IMPORTED_MODULE_7__shared_data_service__["J" /* postStatsLayersHectares */]);
    };
...
var MapComponent = (function () {
    ...
    MapComponent.prototype.createMap = function (basemap) {
        ...
        var self = this;
        this.map = L.map('map', __WEBPACK_IMPORTED_MODULE_1__shared_data_service__["_6" /* map_options */]);
...
var MapService = (function (_super) {
    ...
    function MapService(http, logger, loaderService, toasterService, layersService, selectionScaleService, cmLayerService, selectionToolService, helper, businessInterfaceRenderService, selectionToolButtonStateService) {
        ...
        _this.zoomlevel = new __WEBPACK_IMPORTED_MODULE_13_rxjs_BehaviorSubject__["BehaviorSubject"](__WEBPACK_IMPORTED_MODULE_3__shared_data_service__["P" /* defaultZoomLevel */]);
    ...
    */
    ...
    MapService.prototype.retriveMapEvent = function () {
        var self = this;
        this.map.on(__WEBPACK_IMPORTED_MODULE_3__shared_data_service__["Q" /* MAPCLICK */], function (event) { self.onClickEvent(self, event); });
        this.map.on(__WEBPACK_IMPORTED_MODULE_3__shared_data_service__["R" /* MAPLAYERCHANCE */], function (event) { self.onBaselayerChange(self, event); });
        this.map.on(__WEBPACK_IMPORTED_MODULE_3__shared_data_service__["S" /* MAPZOOMSTART */], function () { self.onZoomStart(self); });
        this.map.on(__WEBPACK_IMPORTED_MODULE_3__shared_data_service__["T" /* MAPZOOMEND */], function () { self.onZoomEnd(self); });
        this.map.on(__WEBPACK_IMPORTED_MODULE_3__shared_data_service__["U" /* MAPLAYERSCONTROLEVENT */], function () { self.onLayersControlEvent(self); });
        this.map.on(__WEBPACK_IMPORTED_MODULE_3__shared_data_service__["V" /* MAPLAYERADD */], function (e) { self.onLayerAdd(self, e); });
        this.map.on(__WEBPACK_IMPORTED_MODULE_3__shared_data_service__["W" /* MAPDIDIUPDATELAYER */], function (event) { self.onDidUpdateLayers(self, event); });
        this.map.on(__WEBPACK_IMPORTED_MODULE_3__shared_data_service__["X" /* MAPOVERLAYADD */], function () { self.onOverLayAdd(self); });
        this.map.on(__WEBPACK_IMPORTED_MODULE_3__shared_data_service__["Y" /* MAPDRAWCREATED */], function (e) { self.onDrawCreated(self, e); });
        this.map.on(__WEBPACK_IMPORTED_MODULE_3__shared_data_service__["Z" /* MAPDRAWEDITED */], function () { self.onDrawEdited(self); });
        this.map.on(__WEBPACK_IMPORTED_MODULE_3__shared_data_service__["_0" /* MAPDRAWSTART */], function () { self.onDrawStart(self); });
        this.map.on(__WEBPACK_IMPORTED_MODULE_3__shared_data_service__["_1" /* MAPDRAWEDITSTART */], function () { self.onDrawEditStart(self); });
        this.map.on(__WEBPACK_IMPORTED_MODULE_3__shared_data_service__["_2" /* MAPDRAWEDITSTOP */], function (e) { self.onDrawEditStop(self, e); });
        this.map.on(__WEBPACK_IMPORTED_MODULE_3__shared_data_service__["_3" /* MAPDRAWDELETED */], function () { self.onDrawDeleted(self); });
    };
    // Event functions
    ...
    MapService.prototype.getNutsGeometryFromNuts = function (latlng, nuts_level) {
        ...
        var bbox = latlng.toBounds(__WEBPACK_IMPORTED_MODULE_3__shared_data_service__["_4" /* clickAccuracy */]).toBBoxString();
        bbox = bbox + '&CQL_FILTER=' + 'stat_levl_=' + current_nuts_level + 'AND ' + 'date=' + '2015' + '-01-01Z';
        var action = 'population';
        var url = __WEBPACK_IMPORTED_MODULE_3__shared_data_service__["_5" /* geoserverGetFeatureInfoUrl */]
    ...
    MapService.prototype.getNutsGeometryFromLau2 = function (latlng, nuts_level) {
        var bbox = latlng.toBounds(__WEBPACK_IMPORTED_MODULE_3__shared_data_service__["_4" /* clickAccuracy */]).toBBoxString();
        var action = __WEBPACK_IMPORTED_MODULE_3__shared_data_service__["H" /* lau2name */];
        var url = __WEBPACK_IMPORTED_MODULE_3__shared_data_service__["_5" /* geoserverGetFeatureInfoUrl */]
            + action + '&STYLES&LAYERS=hotmaps:' + action + '&INFO_FORMAT=application/json&FEATURE_COUNT=50' +
            '&X=50&Y=50&SRS=EPSG:4326&WIDTH=101&HEIGHT=101&BBOX=' + bbox;
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "s", function() { return styleNameHeat; });
/* unused harmony export heat_type */
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "t", function() { return defaultLayerType; });
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "_20", function() { return urlTaigaFeedback; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "_8", function() { return urlLegend; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "_21", function() { return timeOutAjaxRequest; });
/* unused harmony export unit_heatload_profil */
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "G", function() { return formatImage; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "_5", function() { return geoserverGetFeatureInfoUrl; });
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "J", function() { return postStatsLayersHectares; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "I", function() { return postStatsLayersNutsLau; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "y", function() { return postHeatLoadProfileHectares; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "D", function() { return postHeatLoadProfileNutsLau; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "B", function() { return postDurationCurveHectares; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "A", function() { return postDurationCurveNutsLau; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "z", function() { return getElectricityMixFromNuts0; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "_15", function() { return heatloadprofile; });
/* unused harmony export Durationcurve */
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "_22", function() { return energy_mix_title; });
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "_17", function() { return heat_load_api_day; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "_19", function() { return heat_load_api_year; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "_18", function() { return heat_load_api_month; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "_16", function() { return buttons_heat_load; });
/* unused harmony export default_drop_down_button */
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "x", function() { return calculation_module_category; });
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "_4", function() { return clickAccuracy; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "v", function() { return zoomLevelDetectChange; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "L", function() { return constant_year; });
/* unused harmony export constant_year_sp_wwtp */
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "_12", function() { return constant_year_duration_curve; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "u", function() { return business_name_wwtp; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "_7", function() { return business_name_population; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "O", function() { return unit_capacity; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "N", function() { return unit_heat_density; });
/* unused harmony export unit_shape_area */
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "M", function() { return unit_population; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "d", function() { return round_value; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "P", function() { return defaultZoomLevel; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "_6", function() { return map_options; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "H", function() { return lau2name; });
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "E", function() { return initial_scale_value; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "Z", function() { return MAPDRAWEDITED; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "_0", function() { return MAPDRAWSTART; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "_3", function() { return MAPDRAWDELETED; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "_2", function() { return MAPDRAWEDITSTOP; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "_1", function() { return MAPDRAWEDITSTART; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "Y", function() { return MAPDRAWCREATED; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "Q", function() { return MAPCLICK; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "R", function() { return MAPLAYERCHANCE; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "S", function() { return MAPZOOMSTART; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "T", function() { return MAPZOOMEND; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "U", function() { return MAPLAYERSCONTROLEVENT; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "V", function() { return MAPLAYERADD; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "W", function() { return MAPDIDIUPDATELAYER; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "X", function() { return MAPOVERLAYADD; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "_27", function() { return rightPanelSize; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "_26", function() { return leftPanelSize; });
/* unused harmony export default_tab_datapanel */
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "C", function() { return tab1_datapanel; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "_11", function() { return tab2_datapanel; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "_24", function() { return duration_curve_graph_title; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "_25", function() { return duration_curve_graph_category; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "_13", function() { return duration_curve_graph_options; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "_14", function() { return heat_load_graph_options; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "_23", function() { return energy_mix_graph_category; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "_10", function() { return energy_mix_options; });
/* unused harmony export clculation_module_graph_options */
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "_9", function() { return inputs_categories; });
...
/* harmony namespace reexport (by used) */ __webpack_require__.d(__webpack_exports__, "tab1_datapanel", function() { return __WEBPACK_IMPORTED_MODULE_4__data_service__["C"]; });
/* harmony namespace reexport (by used) */ __webpack_require__.d(__webpack_exports__, "lau2name", function() { return __WEBPACK_IMPORTED_MODULE_4__data_service__["H"]; });
/* harmony namespace reexport (by used) */ __webpack_require__.d(__webpack_exports__, "geoserverUrl", function() { return __WEBPACK_IMPORTED_MODULE_4__data_service__["F"]; });
...
/* harmony namespace reexport (by used) */ __webpack_require__.d(__webpack_exports__, "urlLegend", function() { return __WEBPACK_IMPORTED_MODULE_4__data_service__["_8"]; });
...
/* harmony namespace reexport (by used) */ __webpack_require__.d(__webpack_exports__, "heatloadprofile", function() { return __WEBPACK_IMPORTED_MODULE_4__data_service__["_15"]; });
/* harmony namespace reexport (by used) */ __webpack_require__.d(__webpack_exports__, "buttons_heat_load", function() { return __WEBPACK_IMPORTED_MODULE_4__data_service__["_16"]; });
/* harmony namespace reexport (by used) */ __webpack_require__.d(__webpack_exports__, "heat_load_api_day", function() { return __WEBPACK_IMPORTED_MODULE_4__data_service__["_17"]; });
/* harmony namespace reexport (by used) */ __webpack_require__.d(__webpack_exports__, "heat_load_api_month", function() { return __WEBPACK_IMPORTED_MODULE_4__data_service__["_18"]; });
/* harmony namespace reexport (by used) */ __webpack_require__.d(__webpack_exports__, "heat_load_api_year", function() { return __WEBPACK_IMPORTED_MODULE_4__data_service__["_19"]; });
/* harmony namespace reexport (by used) */ __webpack_require__.d(__webpack_exports__, "timeOutAjaxRequest", function() { return __WEBPACK_IMPORTED_MODULE_4__data_service__["_21"]; });
/* harmony namespace reexport (by used) */ __webpack_require__.d(__webpack_exports__, "leftPanelSize", function() { return __WEBPACK_IMPORTED_MODULE_4__data_service__["_26"]; });
/* harmony namespace reexport (by used) */ __webpack_require__.d(__webpack_exports__, "rightPanelSize", function() { return __WEBPACK_IMPORTED_MODULE_4__data_service__["_27"]; });
