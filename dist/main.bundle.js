...
var DataInteractionArray = [
    ...
    { id: __WEBPACK_IMPORTED_MODULE_0__shared_data_service__["A" /* idDefaultLayer */], name: 'Heat density total', category: 'Buildings', isSelected: true,
        workspaceName: 'heat_tot_curr_density', zoomLevel: 0, ref: ['overall', 'demand'], styleName: 'heat_tot_curr_density', layer_type: __WEBPACK_IMPORTED_MODULE_0__shared_data_service__["B" /* defaultLayerType */],
        download_url: gitlabUrl + '/heat/heat_tot_curr_density/raw/master/data/heat_tot_curr_density.tif',
        description: 'Information on the layer can be found here: ' + gitlabUrl + '/heat/heat_tot_curr_density/blob/master/README.md' },
    { id: 15, name: 'Heat density residential sector', category: 'Buildings', isSelected: false,
        workspaceName: 'heat_res_curr_density', zoomLevel: 0, ref: ['overall', 'demand'], styleName: 'heat_tot_curr_density', layer_type: __WEBPACK_IMPORTED_MODULE_0__shared_data_service__["B" /* defaultLayerType */],
        download_url: gitlabUrl + '/heat/heat_res_curr_density/raw/master/data/heat_res_curr_density.tif',
        description: 'Information on the layer can be found here: ' + gitlabUrl + '/heat/heat_res_curr_density/blob/master/README.md' },
    { id: 16, name: 'Heat density non-residential sector', category: 'Buildings', isSelected: false,
        ...
        description: 'Information on the layer can be found here: ' + gitlabUrl + '/heat/heat_nonres_curr_density/blob/master/README.md' },
    { id: 18, name: 'Gross floor area total', category: 'Buildings', isSelected: false,
        ...
        description: 'Information on the layer can be found here: ' + gitlabUrl + '/gfa_tot_curr_density/blob/master/README.md' },
    { id: 19, name: 'Gross floor area residential', category: 'Buildings', isSelected: false,
        ...
        description: 'Information on the layer can be found here: ' + gitlabUrl + '/gfa_res_curr_density/blob/master/README.md' },
    { id: 20, name: 'Gross floor area non-residential', category: 'Buildings', isSelected: false,
        ...
        description: 'Information on the layer can be found here: ' + gitlabUrl + '/gfa_nonres_curr_density/blob/master/README.md' },
    { id: 19, name: 'Building volumes total', category: 'Buildings', isSelected: false,
        ...
        description: 'Information on the layer can be found here: ' + gitlabUrl + '/vol_tot_curr_density/blob/master/README.md' },
    { id: 18, name: 'Building volumes residential', category: 'Buildings', isSelected: false,
        ...
        description: 'Information on the layer can be found here: ' + gitlabUrl + '/vol_res_curr_density/blob/master/README.md' },
    { id: 20, name: 'Building volumes non-residential', category: 'Buildings', isSelected: false,
        ...
        description: 'Information on the layer can be found here: ' + gitlabUrl + '/vol_nonres_curr_density/blob/master/README.md' },
    // Industry
    { id: 45345, name: 'Industrial Sites Emissions', category: 'Industry', isSelected: false,
        ...
        description: 'Information on the layer can be found here: ' + gitlabUrl + '/industrial_sites/industrial_sites_Industrial_Database/blob/master/README.md' },
    ...
    { id: 14, name: 'Population total', category: 'Population', isSelected: false,
        ...
        description: 'Information on the layer can be found here: ' + gitlabUrl + '/pop_tot_curr_density/blob/master/README.md' },
    // Potentials
    { id: 12, name: 'Waste Water Treatment Plants - Power', category: 'R.E.S. Potential', isSelected: false,
        workspaceName: 'wwtp_power', zoomLevel: __WEBPACK_IMPORTED_MODULE_1__shared_data_service__["C" /* zoomLevelDetectChange */], ref: ['overall', 'potential'], styleName: 'default', layer_type: 'wwtp_power',
        download_url: gitlabUrl + '/potential/WWTP/blob/master/data/2015/WWTP_2015.csv',
        description: 'Information on the layer can be found here: ' + gitlabUrl + '/potential/WWTP/blob/master/README.md' },
    { id: 12, name: 'Waste Water Treatment Plants - Capacity', category: 'R.E.S. Potential', isSelected: false,
        workspaceName: 'wwtp_capacity', zoomLevel: __WEBPACK_IMPORTED_MODULE_1__shared_data_service__["C" /* zoomLevelDetectChange */], ref: ['overall', 'potential'], styleName: 'wwtp_capacity', layer_type: 'wwtp_capacity',
        download_url: gitlabUrl + '/potential/WWTP/blob/master/data/2015/WWTP_2015.csv',
        description: 'Information on the layer can be found here: ' + gitlabUrl + '/potential/WWTP/blob/master/README.md' },
    { id: 18, name: 'Agricultural residues', category: 'R.E.S. Potential', isSelected: false,
        ...
        description: 'Information on the layer can be found here: ' + gitlabUrl + '/potential/potential_biomass/blob/master/README.md' },
    ...
    { id: 18, name: 'Forest residues', category: 'R.E.S. Potential', isSelected: false,
        ...
        description: 'Information on the layer can be found here: ' + gitlabUrl + '/potential_biomass/blob/master/README.md' },
    { id: 19, name: 'Municipal solid waste', category: 'R.E.S. Potential', isSelected: false,
        ...
        description: 'Information on the layer can be found here: ' + gitlabUrl + '/potential/potential_municipal_solid_waste/blob/master/README.md' },
    { id: 20, name: 'Wind potential', category: 'R.E.S. Potential', isSelected: false,
        ...
        description: 'Information on the layer can be found here: ' + gitlabUrl + '/potential/potential_wind/blob/master/README.md' },
    { id: 20, name: 'Solar potential', category: 'R.E.S. Potential', isSelected: false,
        ...
        description: 'Information on the layer can be found here: ' + gitlabUrl + '/potential/potential_solar/blob/master/README.md' },
    ...
    { id: 20, name: 'Geothermal Potential Heat Conductivity ', category: 'R.E.S. Potential', isSelected: false,
        ...
        description: 'Information on the layer can be found here: ' + gitlabUrl + '/potential/potential_shallowgeothermal/blob/master/README.md' },
    ...
    { id: 20, name: 'Average Temperature', category: 'Climate', isSelected: false,
        ...
        description: 'Information on the layer can be found here: ' + gitlabUrl + '/climate/climate_land_surface_temperature/blob/master/README.md' },
    { id: 20, name: 'Cooling degree days', category: 'Climate', isSelected: false,
        ...
        description: 'Information on the layer can be found here: ' + gitlabUrl + '/climate/CDD_ha_curr/blob/master/README.md' },
    { id: 20, name: 'Heating degree days', category: 'Climate', isSelected: false,
        ...
        description: 'Information on the layer can be found here: ' + gitlabUrl + '/climate/HDD_ha_curr/blob/master/data/README.md' },
    { id: 20, name: 'Solar radiation', category: 'Climate', isSelected: false,
        ...
        description: 'Information on the layer can be found here: ' + gitlabUrl + '/climate/climate_solar_radiation/blob/master/README.md' },
    { id: 20, name: 'Wind Speed', category: 'Climate', isSelected: false,
        ...
        description: 'Information on the layer can be found here: ' + gitlabUrl + '/climate/climate_wind_speed/blob/master/README.md' },
    // Electricity
    { id: 20, name: 'Electricity CO2 emissions - country average', category: 'Electricity', isSelected: false,
        ...
        description: 'Information on the layer can be found here: ' + gitlabUrl + '/load_electricity/electricity_emissions_hourly/blob/master/README.md' },
    // CMs
    { id: 20, name: 'CM - Heat demand reduction', category: 'CM', isSelected: false,
        workspaceName: 'calculation_module_1', zoomLevel: 0, ref: ['overall', 'demand'], styleName: '', layer_type: __WEBPACK_IMPORTED_MODULE_0__shared_data_service__["D" /* calculation_module_category */] },
];
    ...
    ResultManagerComponent.prototype.getStatusOfCM = function () {
        ...
        this.interactionService.getStatusAndCMResult(this.status_id).then(function (data) {
            ...
            if (response["state"] === 'SUCCESS') {
                ...
                if (!_this.helper.isNullOrUndefined(response.status.result.indicator) && response.status.result.indicator.length >= 1) {
                ...
                if (!_this.helper.isNullOrUndefined(response.status.result.graphics) && response.status.result.graphics.length >= 1) {
...
var BusinessInterfaceRenderArray = [
    ...
    { id: 176, api_name: wwtp_capacity + '_power', business_name: 'Average excess heat power from waste water treatment' },
