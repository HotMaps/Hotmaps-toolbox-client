...
var DataInteractionArray = [
    ...
    { id: 12, name: __WEBPACK_IMPORTED_MODULE_0__shared_data_service__["A" /* business_name_wwtp */], category: 'Ressources', isSelected: false, workspaceName: 'wwtp', zoomLevel: __WEBPACK_IMPORTED_MODULE_1__shared_data_service__["W" /* zoomLevelDetectChange */] },
...
var GraphicalViewComponent = (function () {
    function GraphicalViewComponent(logger) {
        ...
        this.timeline = true;
        this.view = [__WEBPACK_IMPORTED_MODULE_2_app_shared__["rightPanelSize"] - 30, 300];
        // options
        this.showXAxis = true;
        this.showYAxis = true;
        this.gradient = false;
...
var LayersService = (function (_super) {
    ...
    function LayersService(http, logger, loaderService, toasterService, 
        ...
        _this.heatmapOption = {
            layers: 'hotmaps:' + __WEBPACK_IMPORTED_MODULE_8__shared_data_service__["v" /* defaultLayer */] + '_ha' + '_' + __WEBPACK_IMPORTED_MODULE_8__shared_data_service__["t" /* constant_year */],
    ...
    LayersService.prototype.choosePopup = function (map, res, latlng, action) {
        ...
        else if (action === __WEBPACK_IMPORTED_MODULE_8__shared_data_service__["x" /* populationLayerName */] + '_' + __WEBPACK_IMPORTED_MODULE_8__shared_data_service__["t" /* constant_year */]) {
...
var SelectionToolService = (function (_super) {
    ...
    SelectionToolService.prototype.loadResults = function (map, layer) {
        if (this.currentLayer) {
            var layerNameArray = [];
            for (var i = 0; i < this.interactionService.getLayerArray().keys().length; i++) {
                if (this.interactionService.getLayerArray().keys()[i] !== __WEBPACK_IMPORTED_MODULE_3__shared_data_service__["s" /* wwtpLayerName */]) {
    ...
    SelectionToolService.prototype.getStatisticsFromLayer = function (locations, layers, map) {
        ...
        if (this.scaleValue === __WEBPACK_IMPORTED_MODULE_3__shared_data_service__["o" /* nuts2 */]) {
    ...
    SelectionToolService.prototype.drawResult = function (result, map) {
        if (this.helper.isNullOrUndefined(result.feature_collection.type) === false) {
            var geoJson = null;
            if (this.scaleValue === __WEBPACK_IMPORTED_MODULE_3__shared_data_service__["q" /* lau2 */]) {
                proj4.defs('EPSG:3035', __WEBPACK_IMPORTED_MODULE_3__shared_data_service__["u" /* proj3035 */]);
...
module.exports = "<div class=\"containers\">\n  <div id=\"selection-tools-box\">\n    <div>\n      <input id=\"radio-1\" class=\"radio-custom\" name=\"radio-group\" type=\"radio\" checked (click)=\"cursorClick()\">\n      <label id=\"cursor\" for=\"radio-1\" class=\"radio-custom-label\"></label>\n    </div>\n    <div>\n      <input id=\"radio-2\" class=\"radio-custom\" name=\"radio-group\" type=\"radio\" (click)=\"squareClick()\">\n      <label id=\"square\" for=\"radio-2\" class=\"radio-custom-label\"></label>\n    </div>\n    <div>\n      <input id=\"radio-3\" class=\"radio-custom\" name=\"radio-group\" type=\"radio\" (click)=\"circleClick()\">\n      <label id=\"circle\" for=\"radio-3\" class=\"radio-custom-label\"></label>\n    </div>\n    <div>\n      <input id=\"radio-4\" class=\"radio-custom\" name=\"radio-group\" type=\"radio\" (click)=\"polygonClick()\">\n      <label id=\"polygon\" for=\"radio-4\" class=\"radio-custom-label\"></label>\n    </div>\n  </div>\n  <div id=\"info-box\">\n  \t<div class=\"uk-container uk-padding-remove\">\n  \t\t<div>\n  \t\t<p>Element selected<span>{{nbNutsSelected}}</span></p>\n  \t\t<p>Scale<span>{{scaleSelected}}</span></p>\n  \t<!--\t<p>Area<span>0 km2</span></p> -->\n  \t\t</div>\n  \t\t<div class=\"divButtons\">\n  \t\t\t<button id=\"loadBtn\" class=\"uk-button uk-button-primary uk-button-small\" disabled (click)=\"loadResultsButton()\">Load results</button>\n  \t\t\t<button id=\"clearBtn\" class=\"uk-button uk-button-danger uk-button-small\" disabled (click)=\"clearAllButton()\">Clear all</button>\n  \t\t</div>\n  \t</div>\n  </div>\n\n</div>\n"
...
var SelectionToolComponent = (function () {
    ...
    SelectionToolComponent.prototype.ngOnInit = function () {
        ...
        var boxTools = L.DomUtil.get('selection-tools-box');
        var boxInfos = L.DomUtil.get('info-box');
        if (!L.Browser.touch) {
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "Y", function() { return urlSendMail; });
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "u", function() { return proj3035; });
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "X", function() { return rightPanelSize; });
...
// prefer
var geoserverUrl = 'http://hotmaps.hevs.ch:9009/geoserver/hotmaps/wms';
...
/* harmony namespace reexport (by used) */ __webpack_require__.d(__webpack_exports__, "proj3035", function() { return __WEBPACK_IMPORTED_MODULE_4__data_service__["u"]; });
/* harmony namespace reexport (by used) */ __webpack_require__.d(__webpack_exports__, "rightPanelSize", function() { return __WEBPACK_IMPORTED_MODULE_4__data_service__["X"]; });
/* harmony namespace reexport (by used) */ __webpack_require__.d(__webpack_exports__, "urlSendMail", function() { return __WEBPACK_IMPORTED_MODULE_4__data_service__["Y"]; });
