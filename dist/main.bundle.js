...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_65__features_summary_result_summary_result_container_summary_result_container_component__ = __webpack_require__("../../../../../src/app/features/summary-result/summary-result-container/summary-result-container.component.ts");
...
AppModule = __decorate([
    __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_3__angular_core__["NgModule"])({
        ...
        declarations: [
            ...
            __WEBPACK_IMPORTED_MODULE_65__features_summary_result_summary_result_container_summary_result_container_component__["a" /* SummaryResultContainerComponent */],
        ],
        providers: [
...
var CalculationModuleComponent = (function () {
    function CalculationModuleComponent(calculationModuleService, calculationModuleStatusService, interactionService, dataInteractionService, helper, logger, toasterService) {
        ...
        this.inputs_categories = __WEBPACK_IMPORTED_MODULE_0__shared_data_service__["_31" /* inputs_categories */];
...
var ElectricityMixComponent = (function () {
    ...
    ElectricityMixComponent.prototype.ngOnInit = function () {
        this.options = __WEBPACK_IMPORTED_MODULE_3__shared_data_service__["_32" /* energy_mix_options */];
        /* this.update(); */
    };
...
var LayerToolComponent = (function () {
    function LayerToolComponent(mapService, uploadService) {
        ...
        this.imageUrl = __WEBPACK_IMPORTED_MODULE_4__shared_data_service__["_26" /* urlLegend */];
...
var LayersService = (function (_super) {
    ...
    LayersService.prototype.choosePopup = function (map, res, latlng, action) {
        ...
        else if (action === __WEBPACK_IMPORTED_MODULE_8__shared_data_service__["_1" /* populationLayerName */] + '_' + __WEBPACK_IMPORTED_MODULE_8__shared_data_service__["d" /* constant_year */]) {
...
var PopulationService = (function (_super) {
    ...
    */
    PopulationService.prototype.addPopupNuts = function (data, map, latlng, popup) {
        ...
        popup.setLatLng(latlng).setContent('<h5>' + __WEBPACK_IMPORTED_MODULE_4__shared_data_service__["_25" /* business_name_population */] + '</h5> <ul class="uk-list uk-list-divider">' +
...
var ResultManagerComponent = (function () {
    function ResultManagerComponent(helper, interactionService, logger, dataInteractionService, mapService) {
        ...
        this.tab1 = __WEBPACK_IMPORTED_MODULE_0__shared_data_service__["_41" /* tab1_datapanel */];
        this.tab2 = __WEBPACK_IMPORTED_MODULE_0__shared_data_service__["_42" /* tab2_datapanel */];
    ...
    ResultManagerComponent.prototype.updateEnergyMixResult = function () {
        var self = this;
        var graphic = self.addGraphic(__WEBPACK_IMPORTED_MODULE_0__shared_data_service__["_43" /* energy_mix_title */], 'pie', [], [], __WEBPACK_IMPORTED_MODULE_0__shared_data_service__["_32" /* energy_mix_options */], __WEBPACK_IMPORTED_MODULE_0__shared_data_service__["_44" /* energy_mix_graph_category */], true);
...
var AccountComponent = (function (_super) {
    ...
    function AccountComponent(userManagementService, userManagementStatusService, toasterService, interactionService) {
        ...
        _this.diskspaceLabels = __WEBPACK_IMPORTED_MODULE_0__shared_data_service__["_27" /* labels_diskspacechart */];
        _this.diskspaceOptions = __WEBPACK_IMPORTED_MODULE_0__shared_data_service__["_28" /* diskspacechart_options */];
        return _this;
    }
        ...
        if (this.userManagementService.getDiskSpace)
            this.userManagementService.getDiskSpace(this.token).then(function (data) {
                ...
                _this.diskspaceDataset = [{
                        label: 'Account disk',
                        backgroundColor: [__WEBPACK_IMPORTED_MODULE_0__shared_data_service__["_29" /* color_usedspace */], __WEBPACK_IMPORTED_MODULE_0__shared_data_service__["_30" /* color_unusedspace */]],
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "_26", function() { return urlLegend; });
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "_25", function() { return business_name_population; });
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "_41", function() { return tab1_datapanel; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "_42", function() { return tab2_datapanel; });
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "_32", function() { return energy_mix_options; });
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "_29", function() { return color_usedspace; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "_30", function() { return color_unusedspace; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "_27", function() { return labels_diskspacechart; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "_28", function() { return diskspacechart_options; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "_31", function() { return inputs_categories; });
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__toaster_service__ = __webpack_require__("../../../../../src/app/shared/services/toaster.service.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__helper__ = __webpack_require__("../../../../../src/app/shared/helper.ts");
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__api_service__ = __webpack_require__("../../../../../src/app/shared/services/api.service.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_10__logger_service__ = __webpack_require__("../../../../../src/app/shared/services/logger.service.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_11__loader_service__ = __webpack_require__("../../../../../src/app/shared/services/loader.service.ts");
...
var uploadUrl = __WEBPACK_IMPORTED_MODULE_7__shared_data_service__["a" /* apiUrl */] + '/upload/';
...
var UploadService = (function (_super) {
    ...
    function UploadService(userStatus, slcToolsService, helper, /*private mapService: MapService,*/ http, logger, loaderService, toasterService) {
        var _this = _super.call(this, http, logger, loaderService, toasterService) || this;
        ...
        // For Show and Remove
        _this.activeLayers = {};
        _this.uploadedFiles = new __WEBPACK_IMPORTED_MODULE_8_rxjs__["BehaviorSubject"]([]);
        _this.activePersonalLayers = new __WEBPACK_IMPORTED_MODULE_8_rxjs__["BehaviorSubject"]({});
    ...
    UploadService.prototype.delete = function (id) {
        ...
        if (!__webpack_require__.i(__WEBPACK_IMPORTED_MODULE_6_util__["isNumber"])(id))
            id = id.id;
    ...
    UploadService.prototype.show = function (id) {
        ...
        var payload = { id: id, user_token: this.userToken, layer_id: curr_layer.layer, layer_name: curr_layer.name };
        this.activePersonalLayers.value[id] = payload;
    ...
    UploadService.prototype.export = function (layer, schema, year) {
        ...
        var isNuts = true;
        if (year == null)
            year = __WEBPACK_IMPORTED_MODULE_7__shared_data_service__["d" /* constant_year */];
        if (schema == null)
            schema = layerExportInfo.schema;
        if (scale === __WEBPACK_IMPORTED_MODULE_7__shared_data_service__["e" /* lau2 */] || scale === __WEBPACK_IMPORTED_MODULE_7__shared_data_service__["f" /* nuts3 */]) {
            layer += '_' + scale.toLowerCase().replace(' ', ''); // To change in API ?
            nutsOrAreas = this.slcToolsService.nutsIdsSubject.getValue();
        }
        else if (scale === __WEBPACK_IMPORTED_MODULE_7__shared_data_service__["g" /* hectare */]) {
            layer += '_ha';
...
UploadService = __decorate([
    __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Injectable"])(),
    __metadata("design:paramtypes", [typeof (_a = typeof __WEBPACK_IMPORTED_MODULE_2_app_features_user_management_service_user_management_status_service__["a" /* UserManagementStatusService */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_2_app_features_user_management_service_user_management_status_service__["a" /* UserManagementStatusService */]) === "function" && _a || Object, typeof (_b = typeof __WEBPACK_IMPORTED_MODULE_3_app_features_selection_tools__["a" /* SelectionToolService */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_3_app_features_selection_tools__["a" /* SelectionToolService */]) === "function" && _b || Object, typeof (_c = typeof __WEBPACK_IMPORTED_MODULE_5__helper__["a" /* Helper */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_5__helper__["a" /* Helper */]) === "function" && _c || Object, typeof (_d = typeof __WEBPACK_IMPORTED_MODULE_1__angular_http__["c" /* Http */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_1__angular_http__["c" /* Http */]) === "function" && _d || Object, typeof (_e = typeof __WEBPACK_IMPORTED_MODULE_10__logger_service__["a" /* Logger */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_10__logger_service__["a" /* Logger */]) === "function" && _e || Object, typeof (_f = typeof __WEBPACK_IMPORTED_MODULE_11__loader_service__["a" /* LoaderService */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_11__loader_service__["a" /* LoaderService */]) === "function" && _f || Object, typeof (_g = typeof __WEBPACK_IMPORTED_MODULE_4__toaster_service__["a" /* ToasterService */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_4__toaster_service__["a" /* ToasterService */]) === "function" && _g || Object])
], UploadService);
