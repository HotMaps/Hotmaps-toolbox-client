...
var DataInteractionArray = [
    ...
    { id: __WEBPACK_IMPORTED_MODULE_0__shared_data_service__["u" /* idDefaultLayer */], name: 'Heat Map', category: 'Comsumption', isSelected: true, workspaceName: __WEBPACK_IMPORTED_MODULE_0__shared_data_service__["t" /* defaultLayer */], zoomLevel: 0 },
    { id: 12, name: __WEBPACK_IMPORTED_MODULE_0__shared_data_service__["y" /* business_name_wwtp */], category: 'Ressources', isSelected: false, workspaceName: 'wwtp', zoomLevel: __WEBPACK_IMPORTED_MODULE_1__shared_data_service__["U" /* zoomLevelDetectChange */] },
    { id: 14, name: 'Population', category: 'Comsumption', isSelected: false, workspaceName: __WEBPACK_IMPORTED_MODULE_0__shared_data_service__["v" /* populationLayerName */], zoomLevel: 0 },
];
...
var LayersService = (function (_super) {
    ...
    function LayersService(http, logger, loaderService, toasterService, 
        ...
        _this.heatmapOption = {
            layers: 'hotmaps:' + __WEBPACK_IMPORTED_MODULE_8__shared_data_service__["t" /* defaultLayer */] + '_ha' + '_' + __WEBPACK_IMPORTED_MODULE_8__shared_data_service__["s" /* constant_year */],
            format: 'image/png', transparent: true, version: '1.3.0',
            zIndex: __WEBPACK_IMPORTED_MODULE_8__shared_data_service__["u" /* idDefaultLayer */]
        };
        _this.layersArray = new __WEBPACK_IMPORTED_MODULE_7__shared_class_dictionary_class__["a" /* Dictionary */]([
            {
                key: __WEBPACK_IMPORTED_MODULE_8__shared_data_service__["t" /* defaultLayer */], value: _this.getTilayer(_this.heatmapOption, _this.loaderService)
            },
        ]);
        _this.popup = L.popup();
        return _this;
    ...
    LayersService.prototype.setupDefaultLayer = function () {
        var layer = this.layersArray.value(__WEBPACK_IMPORTED_MODULE_8__shared_data_service__["t" /* defaultLayer */]);
    ...
    LayersService.prototype.choosePopup = function (map, res, latlng, action) {
        if (this.layersArray.containsKey(__WEBPACK_IMPORTED_MODULE_8__shared_data_service__["t" /* defaultLayer */])) {
        ...
        else if (action === __WEBPACK_IMPORTED_MODULE_8__shared_data_service__["v" /* populationLayerName */] + '_' + __WEBPACK_IMPORTED_MODULE_8__shared_data_service__["s" /* constant_year */]) {
    ...
    LayersService.prototype.addPopupWWTP = function (map, data, latlng) {
        ...
        this.popup.setLatLng(latlng).setContent('<h5>' + __WEBPACK_IMPORTED_MODULE_8__shared_data_service__["y" /* business_name_wwtp */] + '</h5> <ul class="uk-list uk-list-divider">' +
            '<li>Capacity: ' + capacity + ' ' + __WEBPACK_IMPORTED_MODULE_8__shared_data_service__["z" /* unit_capacity */] + '</li><li>Power: ' + this.helper.round(power) + ' ' + unit + '</li>' +
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__shared_data_service__ = __webpack_require__("../../../../../src/app/shared/data.service.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__shared_business_business_service__ = __webpack_require__("../../../../../src/app/shared/business/business.service.ts");
...
var SelectionToolService = (function () {
    function SelectionToolService(logger, loaderService, helper, businessInterfaceRenderService, interactionService) {
        ...
        this.scaleValue = __WEBPACK_IMPORTED_MODULE_4__shared_data_service__["d" /* initial_scale_value */];
    }
    ...
    SelectionToolService.prototype.loadPopup = function (map, layer) {
        ...
        L.DomEvent.on(this.validationBtnSelection, 'click', function () {
            ...
            for (var i = 0; i < _this.interactionService.getLayerArray().keys().length; i++) {
                if (_this.interactionService.getLayerArray().keys()[i] !== __WEBPACK_IMPORTED_MODULE_4__shared_data_service__["r" /* wwtpLayerName */]) {
    ...
    SelectionToolService.prototype.getStatisticsFromLayer = function (locations, layers, map) {
        ...
        var payload = { layers: layers, year: __WEBPACK_IMPORTED_MODULE_4__shared_data_service__["s" /* constant_year */], points: locations };
        ...
        if (this.scaleValue === __WEBPACK_IMPORTED_MODULE_4__shared_data_service__["n" /* nuts2 */]) {
...
var LeftSideComponent = (function (_super) {
    ...
    LeftSideComponent.prototype.closePanel = function () {
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "t", function() { return defaultLayer; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "u", function() { return idDefaultLayer; });
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "v", function() { return populationLayerName; });
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "A", function() { return proj3035; });
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "y", function() { return business_name_wwtp; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "T", function() { return business_name_population; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "z", function() { return unit_capacity; });
...
/* harmony namespace reexport (by used) */ __webpack_require__.d(__webpack_exports__, "proj3035", function() { return __WEBPACK_IMPORTED_MODULE_4__data_service__["A"]; });
