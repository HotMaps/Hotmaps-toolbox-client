...
var LayersService = (function (_super) {
    ...
    LayersService.prototype.refreshLayersOnMap = function (map) {
        ...
        for (var i = 0; i < layers.length; i++) {
            if (layers[i] !== __WEBPACK_IMPORTED_MODULE_5__shared_data_service__["e" /* defaultLayer */]) {
    ...
    MapService.prototype.retriveMapEvent = function () {
        ...
        this.map.on('click', function (e) {
            ...
            self.layersService.getIsReadyToShowFeatureInfo() === true) {
                self.layersService.getDetailLayerPoint(__WEBPACK_IMPORTED_MODULE_7__shared_data_service__["j" /* wwtpLayerName */], e.latlng, self.map);
            }
        });
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__features_side_panel_side_panel_service__ = __webpack_require__("../../../../../src/app/features/side-panel/side-panel.service.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__features_feedback_mail_service__ = __webpack_require__("../../../../../src/app/features/feedback/mail.service.ts");
...
var NavigationBarService = (function () {
    function NavigationBarService(panelService, selectionToolButtonStateService, mailService) {
        this.panelService = panelService;
        this.selectionToolButtonStateService = selectionToolButtonStateService;
...
var BusinessInterfaceRenderArray = [
    ...
    { id: 25, api_name: 'population_density_sum', business_name: 'Population density' },
