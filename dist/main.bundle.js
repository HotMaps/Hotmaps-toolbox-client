...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_62__features_side_panel_folder_panel_folder_panel_component__ = __webpack_require__("../../../../../src/app/features/side-panel/folder-panel/folder-panel.component.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_63__features_side_panel_save_panel_save_panel_component__ = __webpack_require__("../../../../../src/app/features/side-panel/save-panel/save-panel.component.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_64__features_feedback_feedback_service__ = __webpack_require__("../../../../../src/app/features/feedback/feedback.service.ts");
...
AppModule = __decorate([
    __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_3__angular_core__["NgModule"])({
        ...
        declarations: [
            ...
            __WEBPACK_IMPORTED_MODULE_63__features_side_panel_save_panel_save_panel_component__["a" /* SavePanelComponent */],
            __WEBPACK_IMPORTED_MODULE_62__features_side_panel_folder_panel_folder_panel_component__["a" /* FolderPanelComponent */]
        ],
        providers: [
            ...
            __WEBPACK_IMPORTED_MODULE_64__features_feedback_feedback_service__["a" /* FeedbackService */]
        ],
        schemas: [
...
var DurationCurveComponent = (function () {
    ...
    DurationCurveComponent.prototype.update = function () {
        ...
        if (this.scaleLevel === '-1') {
            isHectare = true;
            payload = this.helper.createDCPayloadHectares(__WEBPACK_IMPORTED_MODULE_4__shared_data_service__["_32" /* constant_year_duration_curve */], this.durationCurvePayload.areas);
        }
        else {
            payload = this.helper.createDCPayloadNuts(__WEBPACK_IMPORTED_MODULE_4__shared_data_service__["_32" /* constant_year_duration_curve */], this.durationCurvePayload.nuts);
        }
        ...
        this.interactionService.getDurationCurveWithPayload(payload, isHectare).then(function (result) {
            ...
            _this.options = __WEBPACK_IMPORTED_MODULE_4__shared_data_service__["_33" /* duration_curve_graph_options */];
        }).then(function () {
...
var DurationCurveService = (function (_super) {
    ...
    DurationCurveService.prototype.getDurationCurveWithPayload = function (payload, isHectare) {
        if (isHectare === false) {
            ...
            return _super.prototype.POST.call(this, payload, __WEBPACK_IMPORTED_MODULE_8__shared_data_service__["a" /* apiUrl */] + __WEBPACK_IMPORTED_MODULE_8__shared_data_service__["N" /* postDurationCurveNutsLau */]);
        }
        else {
            this.logger.log('DurationCurveService/getDurationCurveWithPayload = ' + JSON.stringify(payload));
            return _super.prototype.POST.call(this, payload, __WEBPACK_IMPORTED_MODULE_8__shared_data_service__["a" /* apiUrl */] + __WEBPACK_IMPORTED_MODULE_8__shared_data_service__["O" /* postDurationCurveHectares */]);
        }
    };
...
var ElectricityMixService = (function (_super) {
    ...
    ElectricityMixService.prototype.getElectricityMix = function (payload) {
        this.logger.log(__WEBPACK_IMPORTED_MODULE_7_app_shared_data_service__["a" /* apiUrl */] + __WEBPACK_IMPORTED_MODULE_7_app_shared_data_service__["L" /* postHeatLoadProfileHectares */]);
        return _super.prototype.POST.call(this, payload, __WEBPACK_IMPORTED_MODULE_7_app_shared_data_service__["a" /* apiUrl */] + __WEBPACK_IMPORTED_MODULE_7_app_shared_data_service__["M" /* getElectricityMixFromNuts0 */]);
    };
    ...
    HeatLoadChartComponent.prototype.update = function () {
        ...
        if (this.buttons_date_type !== undefined) {
            ...
            this.interactionService.getHeatLoad(payload, this.selectedButton.api_ref, isHectare).then(function (result) {
                ...
                _this.options = __WEBPACK_IMPORTED_MODULE_3__shared_data_service__["_34" /* heat_load_graph_options */];
...
var HeatLoadAggregateService = (function (_super) {
    ...
    HeatLoadAggregateService.prototype.getHeatLoad = function (payload, type_api_ref, isHectare) {
        if (isHectare === false) {
            ...
            this.logger.log('postHeatLoadProfileHectares ' + __WEBPACK_IMPORTED_MODULE_8__shared_data_service__["a" /* apiUrl */] + __WEBPACK_IMPORTED_MODULE_8__shared_data_service__["L" /* postHeatLoadProfileHectares */] + type_api_ref + ' ; payload:' + JSON.stringify(payload));
            this.logger.log(__WEBPACK_IMPORTED_MODULE_8__shared_data_service__["a" /* apiUrl */] + __WEBPACK_IMPORTED_MODULE_8__shared_data_service__["L" /* postHeatLoadProfileHectares */]);
            return _super.prototype.POST.call(this, payload, __WEBPACK_IMPORTED_MODULE_8__shared_data_service__["a" /* apiUrl */] + __WEBPACK_IMPORTED_MODULE_8__shared_data_service__["L" /* postHeatLoadProfileHectares */]);
        }
    };
    ...
    LayerToolComponent.prototype.ngOnInit = function () {
        ...
        if (this.mapService.getLoadResultbuttonState()) {
            this.mapService.getLoadResultbuttonState().subscribe(function (value) { return _this.hasZoneSelected = value
                && [__WEBPACK_IMPORTED_MODULE_4__shared_data_service__["f" /* nuts3 */], __WEBPACK_IMPORTED_MODULE_4__shared_data_service__["e" /* lau2 */], __WEBPACK_IMPORTED_MODULE_4__shared_data_service__["g" /* hectare */]].indexOf(_this.mapService.getScaleValue()) > -1; });
        }
    };
...
var DataInteractionCellComponent = (function () {
    function DataInteractionCellComponent(mapService, interactionService) {
        ...
        this.interactionService = interactionService;
        this.loading = true;
        this.cm_cat = __WEBPACK_IMPORTED_MODULE_0__shared_data_service__["K" /* calculation_module_category */];
    }
    ...
    DataInteractionCellComponent.prototype.showRemoveLayer = function (e) {
        if (this.interactionService.getSummaryResultState() === false) {
            ...
            if (this.dataInteraction.category === __WEBPACK_IMPORTED_MODULE_0__shared_data_service__["K" /* calculation_module_category */]) {
...
var DataInteractionArray = [
    // Buildings
    { id: __WEBPACK_IMPORTED_MODULE_0__shared_data_service__["G" /* idDefaultLayer */], name: 'Heat density total', category: 'Buildings', isSelected: true,
        workspaceName: 'heat_tot_curr_density', zoomLevel: 0, ref: ['overall', 'demand'], styleName: 'heat_tot_curr_density', layer_type: __WEBPACK_IMPORTED_MODULE_0__shared_data_service__["H" /* defaultLayerType */],
    ...
    { id: 15, name: 'Heat density residential sector', category: 'Buildings', isSelected: false,
        workspaceName: 'heat_res_curr_density', zoomLevel: 0, ref: ['overall', 'demand'], styleName: 'heat_tot_curr_density', layer_type: __WEBPACK_IMPORTED_MODULE_0__shared_data_service__["H" /* defaultLayerType */],
    ...
    { id: 16, name: 'Heat density non-residential sector', category: 'Buildings', isSelected: false,
        workspaceName: 'heat_nonres_curr_density', zoomLevel: 0, ref: ['overall', 'demand'], styleName: 'heat_tot_curr_density', layer_type: __WEBPACK_IMPORTED_MODULE_0__shared_data_service__["H" /* defaultLayerType */],
    ...
    { id: 45345, name: 'Industrial Sites Emissions', category: 'Industry', isSelected: false,
        workspaceName: 'industrial_database_emissions', zoomLevel: 0, ref: ['overall', 'industry'], styleName: 'industrial_emissions', layer_type: 'industrial_database_emissions', order: __WEBPACK_IMPORTED_MODULE_0__shared_data_service__["I" /* industry_layer_order */],
    ...
    { id: 20, name: 'Industrial Sites Excess Heat', category: 'Industry', isSelected: false,
        workspaceName: 'industrial_database_excess_heat', zoomLevel: 0, ref: ['overall', 'industry'], styleName: 'industrial_excess_heat', layer_type: 'industrial_database_excess_heat', order: __WEBPACK_IMPORTED_MODULE_0__shared_data_service__["I" /* industry_layer_order */],
        download_url: gitlabUrl + '/industrial_sites/industrial_sites_Industrial_Database/blob/master/data/Industrial_Database.csv',
        description: 'Information on the layer can be found here: ' + gitlabUrl + '/industrial_sites/industrial_sites_Industrial_Database/blob/master/README.md', isLoading: false },
    { id: 45345, name: 'Industrial Sites Company Name', category: 'Industry', isSelected: false,
        workspaceName: 'industrial_database_compagnyname', zoomLevel: 0, ref: ['overall', 'industry'], styleName: 'industrial_compagny_name', layer_type: 'industrial_database_compagnyname', order: __WEBPACK_IMPORTED_MODULE_0__shared_data_service__["I" /* industry_layer_order */],
        download_url: gitlabUrl + '/industrial_sites/industrial_sites_Industrial_Database/blob/master/data/Industrial_Database.csv',
        description: 'Information on the layer can be found here: ' + gitlabUrl + '/industrial_sites/industrial_sites_Industrial_Database/blob/master/README.md', isLoading: false },
    { id: 20, name: 'Industrial Sites Subsector', category: 'Industry', isSelected: false,
        workspaceName: 'industrial_database_subsector', zoomLevel: 0, ref: ['overall', 'industry'], styleName: 'industrial_subsector', layer_type: 'industrial_database_subsector', order: __WEBPACK_IMPORTED_MODULE_0__shared_data_service__["I" /* industry_layer_order */],
        download_url: gitlabUrl + '/industrial_sites/industrial_sites_Industrial_Database/blob/master/data/Industrial_Database.csv',
        description: 'Information on the layer can be found here: ' + gitlabUrl + '/industrial_sites/industrial_sites_Industrial_Database/blob/master/README.md', isLoading: false },
    // Population
    ...
    { id: 12, name: 'Waste Water Treatment Plants - Power', category: 'R.E.S. Potential', isSelected: false,
        workspaceName: 'wwtp_power', zoomLevel: __WEBPACK_IMPORTED_MODULE_1__shared_data_service__["J" /* zoomLevelDetectChange */], ref: ['overall', 'potential'], styleName: 'default', layer_type: 'wwtp_power',
    ...
    { id: 12, name: 'Waste Water Treatment Plants - Capacity', category: 'R.E.S. Potential', isSelected: false,
        workspaceName: 'wwtp_capacity', zoomLevel: __WEBPACK_IMPORTED_MODULE_1__shared_data_service__["J" /* zoomLevelDetectChange */], ref: ['overall', 'potential'], styleName: 'wwtp_capacity', layer_type: 'wwtp_capacity',
        download_url: gitlabUrl + '/potential/WWTP/blob/master/data/2015/WWTP_2015.csv',
        description: 'Information on the layer can be found here: ' + gitlabUrl + '/potential/WWTP/blob/master/README.md', isLoading: false },
...
var cm_default_layer = {
    id: 21, name: '',
    category: __WEBPACK_IMPORTED_MODULE_0__shared_data_service__["K" /* calculation_module_category */],
    isSelected: true,
    workspaceName: '',
    zoomLevel: 0, ref: ['overall', __WEBPACK_IMPORTED_MODULE_0__shared_data_service__["K" /* calculation_module_category */]],
    styleName: '',
    layer_type: __WEBPACK_IMPORTED_MODULE_0__shared_data_service__["K" /* calculation_module_category */],
    cm_id: '',
    isLoading: false
};
...
var LayersService = (function (_super) {
    ...
    LayersService.prototype.choosePopup = function (map, res, latlng, action) {
        ...
        else if (action === __WEBPACK_IMPORTED_MODULE_8__shared_data_service__["_0" /* populationLayerName */] + '_' + __WEBPACK_IMPORTED_MODULE_8__shared_data_service__["d" /* constant_year */]) {
...
var ResultManagerComponent = (function () {
    function ResultManagerComponent(helper, interactionService, logger, dataInteractionService, mapService) {
        ...
        this.tab1 = __WEBPACK_IMPORTED_MODULE_0__shared_data_service__["_40" /* tab1_datapanel */];
        this.tab2 = __WEBPACK_IMPORTED_MODULE_0__shared_data_service__["_41" /* tab2_datapanel */];
        this.cm_catedory = __WEBPACK_IMPORTED_MODULE_0__shared_data_service__["K" /* calculation_module_category */];
    ...
    ResultManagerComponent.prototype.updateEnergyMixResult = function () {
        var self = this;
        var graphic = self.addGraphic(__WEBPACK_IMPORTED_MODULE_0__shared_data_service__["_42" /* energy_mix_title */], 'pie', [], [], __WEBPACK_IMPORTED_MODULE_0__shared_data_service__["_31" /* energy_mix_options */], __WEBPACK_IMPORTED_MODULE_0__shared_data_service__["_43" /* energy_mix_graph_category */], true);
    ...
    ResultManagerComponent.prototype.updateHeatLoadResult = function () {
        this.heatloadGraph = this.addGraphic(__WEBPACK_IMPORTED_MODULE_0__shared_data_service__["_35" /* heatloadprofile */], 'line', [], [], __WEBPACK_IMPORTED_MODULE_0__shared_data_service__["_34" /* heat_load_graph_options */], 'heatload', true);
    };
    ResultManagerComponent.prototype.updateDurationCurveResult = function () {
        var _this = this;
        var self = this;
        var graphic = self.addGraphic(__WEBPACK_IMPORTED_MODULE_0__shared_data_service__["_44" /* duration_curve_graph_title */], 'line', [], [], __WEBPACK_IMPORTED_MODULE_0__shared_data_service__["_33" /* duration_curve_graph_options */], __WEBPACK_IMPORTED_MODULE_0__shared_data_service__["_45" /* duration_curve_graph_category */], true);
        var isHectare;
        if (this.scaleLevel === '-1') {
            isHectare = true;
        }
        ...
        if (response["state"] === 'SUCCESS') {
            ...
            if (!this.helper.isNullOrUndefined(response.status.result.raster_layers)) {
                response.status.result.raster_layers.map(function (raster) {
                    ...
                    _this.dataInteractionService.addNewLayer(name_of_result_1, raster.path, __WEBPACK_IMPORTED_MODULE_0__shared_data_service__["B" /* raster_type_name */], symb);
                    _this.mapService.displayCustomLayerFromCM(raster.path, __WEBPACK_IMPORTED_MODULE_0__shared_data_service__["B" /* raster_type_name */]);
                });
            }
            if (!this.helper.isNullOrUndefined(response.status.result.vector_layers)) {
                response.status.result.vector_layers.map(function (vector) {
                    ...
                    _this.dataInteractionService.addNewLayer(name_of_result_1, vector.path, __WEBPACK_IMPORTED_MODULE_0__shared_data_service__["C" /* vector_type_name */], symb);
            ...
            if (!this.helper.isNullOrUndefined(response.status.result.indicator) && response.status.result.indicator.length >= 1) {
                this.result.indicators.layers.push({
                    name: name_of_result_1, values: response.status.result.indicator, category: ['overall', __WEBPACK_IMPORTED_MODULE_0__shared_data_service__["K" /* calculation_module_category */]]
                });
                this.indicatorExportButtonState = true;
            }
            this.indicatorLoading = false;
            if (!this.helper.isNullOrUndefined(response.status.result.graphics) && response.status.result.graphics.length >= 1) {
                response.status.result.graphics.map(function (graphic) {
                    ...
                    var graph = _this.addGraphic(name_of_result_1, graphic.type, graphic.data.datasets, graphic.data.labels, option_calculation_module, __WEBPACK_IMPORTED_MODULE_0__shared_data_service__["K" /* calculation_module_category */], false);
                });
...
var SelectionScaleService = (function (_super) {
    ...
    function SelectionScaleService(http, logger, loaderService, toasterService) {
        ...
        // scale value subject
        _this.scaleValueSubject = new __WEBPACK_IMPORTED_MODULE_9_rxjs__["BehaviorSubject"](__WEBPACK_IMPORTED_MODULE_8__shared_data_service__["f" /* nuts3 */]);
        return _this;
    }
...
var LeftSideComponent = (function (_super) {
        ...
        if (this.mapService.getNutsSelectedSubject()) {
            this.mapService.getNutsSelectedSubject().subscribe(function (value) {
                ...
                if (value === 0) {
                    ...
                    if (_this.scaleLevel === __WEBPACK_IMPORTED_MODULE_10__shared_data_service__["g" /* hectare */]) {
    ...
    LeftSideComponent.prototype.getLayerAndCategory = function (layers) {
        ...
        this.category.push(__WEBPACK_IMPORTED_MODULE_0__shared_data_service__["K" /* calculation_module_category */]);
    };
...
var RightSideComponent = (function (_super) {
    ...
    RightSideComponent.prototype.setSummaryPayloadIds = function () {
        var payload = { layers: this.layers, year: __WEBPACK_IMPORTED_MODULE_6__shared_data_service__["d" /* constant_year */], scale_level: this.interactionService.getScaleLevel(), nuts: this.nutsIds };
    ...
    RightSideComponent.prototype.setSummaryPayloadArea = function () {
        ...
        this.summaryPayload = { layers: this.layers, year: __WEBPACK_IMPORTED_MODULE_6__shared_data_service__["d" /* constant_year */], scale_level: this.interactionService.getScaleLevel(), areas: areas };
    };
    ...
    RightSideComponent.prototype.setDurationCurveIds = function () {
        this.durationCurvePayload = { nuts: this.nutsIds, year: __WEBPACK_IMPORTED_MODULE_6__shared_data_service__["_32" /* constant_year_duration_curve */], scale_level: this.interactionService.getScaleLevel() };
    };
    RightSideComponent.prototype.setDurationCurveAreas = function () {
        this.durationCurvePayload = { areas: this.helper.getAreasForPayload(this.areas), year: __WEBPACK_IMPORTED_MODULE_6__shared_data_service__["_32" /* constant_year_duration_curve */], };
    };
...
var UserManagementService = (function (_super) {
    ...
    UserManagementService.prototype.userRegister = function (payload) {
        return _super.prototype.POST.call(this, payload, __WEBPACK_IMPORTED_MODULE_2_app_shared_data_service__["a" /* apiUrl */] + __WEBPACK_IMPORTED_MODULE_2_app_shared_data_service__["n" /* post_user_register */]);
    };
    UserManagementService.prototype.userRegisterActivate = function (payload) {
        return _super.prototype.POST.call(this, payload, __WEBPACK_IMPORTED_MODULE_2_app_shared_data_service__["a" /* apiUrl */] + __WEBPACK_IMPORTED_MODULE_3__shared_data_service__["o" /* post_user_register_activate */]);
    };
    UserManagementService.prototype.userLogin = function (payload) {
        return _super.prototype.POST.call(this, payload, __WEBPACK_IMPORTED_MODULE_2_app_shared_data_service__["a" /* apiUrl */] + __WEBPACK_IMPORTED_MODULE_3__shared_data_service__["p" /* post_user_login */]);
    };
    UserManagementService.prototype.userLogout = function (token) {
        return _super.prototype.POST.call(this, this.getTokenPayload(token), __WEBPACK_IMPORTED_MODULE_2_app_shared_data_service__["a" /* apiUrl */] + __WEBPACK_IMPORTED_MODULE_3__shared_data_service__["q" /* post_user_logout */]);
    };
    UserManagementService.prototype.userRecover = function (payload) {
        return _super.prototype.POST.call(this, payload, __WEBPACK_IMPORTED_MODULE_2_app_shared_data_service__["a" /* apiUrl */] + __WEBPACK_IMPORTED_MODULE_3__shared_data_service__["r" /* post_user_recovery */]);
    };
    UserManagementService.prototype.userRecoverAsk = function (payload) {
        return _super.prototype.POST.call(this, payload, __WEBPACK_IMPORTED_MODULE_2_app_shared_data_service__["a" /* apiUrl */] + __WEBPACK_IMPORTED_MODULE_3__shared_data_service__["s" /* post_user_recovery_ask */]);
    };
    UserManagementService.prototype.getDiskSpace = function (token) {
        return _super.prototype.POST.call(this, this.getTokenPayload(token), __WEBPACK_IMPORTED_MODULE_2_app_shared_data_service__["a" /* apiUrl */] + __WEBPACK_IMPORTED_MODULE_2_app_shared_data_service__["t" /* get_diskspace_endpoint */]);
    };
    UserManagementService.prototype.getAcountFileList = function (token) {
        return _super.prototype.POST.call(this, this.getTokenPayload(token), __WEBPACK_IMPORTED_MODULE_2_app_shared_data_service__["a" /* apiUrl */] + __WEBPACK_IMPORTED_MODULE_2_app_shared_data_service__["u" /* get_filelist_endpoint */]);
    };
    UserManagementService.prototype.getUserInformations = function (token) {
        return _super.prototype.POST.call(this, this.getTokenPayload(token), __WEBPACK_IMPORTED_MODULE_2_app_shared_data_service__["a" /* apiUrl */] + __WEBPACK_IMPORTED_MODULE_2_app_shared_data_service__["v" /* get_userinformation_endpoint */]);
    };
    UserManagementService.prototype.userUpdateProfile = function (payload) {
        return _super.prototype.POST.call(this, payload, __WEBPACK_IMPORTED_MODULE_2_app_shared_data_service__["a" /* apiUrl */] + __WEBPACK_IMPORTED_MODULE_2_app_shared_data_service__["w" /* get_userupdateprofile_endpoint */]);
    };
...
var MapService = (function (_super) {
    ...
    */
    ...
    MapService.prototype.onClickEvent = function (self, e) {
        if (self.getScaleValue() === __WEBPACK_IMPORTED_MODULE_3__shared_data_service__["g" /* hectare */]) {
            return;
        }
        ...
        if (self.selectionScaleService.getScaleValue() === __WEBPACK_IMPORTED_MODULE_3__shared_data_service__["g" /* hectare */]) {
...
/* harmony namespace reexport (by used) */ __webpack_require__.d(__webpack_exports__, "b", function() { return __WEBPACK_IMPORTED_MODULE_3__nuts_data__["a"]; });
...
var NutsRenderArray = [
    { id: 0, api_name: '0', business_name: __WEBPACK_IMPORTED_MODULE_0__data_service__["D" /* nuts0 */], suffix: '' },
    { id: 1, api_name: '1', business_name: __WEBPACK_IMPORTED_MODULE_0__data_service__["E" /* nuts1 */], suffix: '' },
    { id: 2, api_name: '2', business_name: __WEBPACK_IMPORTED_MODULE_0__data_service__["F" /* nuts2 */], suffix: '' },
    { id: 3, api_name: '3', business_name: __WEBPACK_IMPORTED_MODULE_0__data_service__["f" /* nuts3 */], suffix: '' },
    { id: 4, api_name: '4', business_name: __WEBPACK_IMPORTED_MODULE_0__data_service__["e" /* lau2 */], suffix: '' },
    { id: 5, api_name: '-1', business_name: __WEBPACK_IMPORTED_MODULE_0__data_service__["g" /* hectare */], suffix: '' },
];
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "H", function() { return defaultLayerType; });
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "O", function() { return postDurationCurveHectares; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "N", function() { return postDurationCurveNutsLau; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "M", function() { return getElectricityMixFromNuts0; });
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "n", function() { return post_user_register; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "o", function() { return post_user_register_activate; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "s", function() { return post_user_recovery_ask; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "r", function() { return post_user_recovery; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "q", function() { return post_user_logout; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "p", function() { return post_user_login; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "v", function() { return get_userinformation_endpoint; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "w", function() { return get_userupdateprofile_endpoint; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "t", function() { return get_diskspace_endpoint; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "u", function() { return get_filelist_endpoint; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "_35", function() { return heatloadprofile; });
/* unused harmony export Durationcurve */
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "_42", function() { return energy_mix_title; });
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "_37", function() { return heat_load_api_day; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "_39", function() { return heat_load_api_year; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "_38", function() { return heat_load_api_month; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "_36", function() { return buttons_heat_load; });
/* unused harmony export default_drop_down_button */
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "K", function() { return calculation_module_category; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "B", function() { return raster_type_name; });
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "I", function() { return industry_layer_order; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "T", function() { return scale_layer_order; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "x", function() { return cm_layers_order; });
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "J", function() { return zoomLevelDetectChange; });
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "_32", function() { return constant_year_duration_curve; });
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "D", function() { return nuts0; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "E", function() { return nuts1; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "F", function() { return nuts2; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "f", function() { return nuts3; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "e", function() { return lau2; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "g", function() { return hectare; });
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "_47", function() { return rightPanelSize; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "_46", function() { return leftPanelSize; });
/* unused harmony export default_tab_datapanel */
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "_40", function() { return tab1_datapanel; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "_41", function() { return tab2_datapanel; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "_44", function() { return duration_curve_graph_title; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "_45", function() { return duration_curve_graph_category; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "_33", function() { return duration_curve_graph_options; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "_34", function() { return heat_load_graph_options; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "_43", function() { return energy_mix_graph_category; });
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "y", function() { return default_color_shpfile; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "z", function() { return default_fillColor_shpfile; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "A", function() { return default_fillOpacity_shpfile; });
...
/* harmony namespace reexport (by used) */ __webpack_require__.d(__webpack_exports__, "cm_layers_order", function() { return __WEBPACK_IMPORTED_MODULE_4__data_service__["x"]; });
/* harmony namespace reexport (by used) */ __webpack_require__.d(__webpack_exports__, "default_color_shpfile", function() { return __WEBPACK_IMPORTED_MODULE_4__data_service__["y"]; });
/* harmony namespace reexport (by used) */ __webpack_require__.d(__webpack_exports__, "default_fillColor_shpfile", function() { return __WEBPACK_IMPORTED_MODULE_4__data_service__["z"]; });
/* harmony namespace reexport (by used) */ __webpack_require__.d(__webpack_exports__, "default_fillOpacity_shpfile", function() { return __WEBPACK_IMPORTED_MODULE_4__data_service__["A"]; });
/* harmony namespace reexport (by used) */ __webpack_require__.d(__webpack_exports__, "raster_type_name", function() { return __WEBPACK_IMPORTED_MODULE_4__data_service__["B"]; });
...
/* harmony namespace reexport (by used) */ __webpack_require__.d(__webpack_exports__, "hectare", function() { return __WEBPACK_IMPORTED_MODULE_4__data_service__["g"]; });
/* harmony namespace reexport (by used) */ __webpack_require__.d(__webpack_exports__, "heatloadprofile", function() { return __WEBPACK_IMPORTED_MODULE_4__data_service__["_35"]; });
/* harmony namespace reexport (by used) */ __webpack_require__.d(__webpack_exports__, "buttons_heat_load", function() { return __WEBPACK_IMPORTED_MODULE_4__data_service__["_36"]; });
/* harmony namespace reexport (by used) */ __webpack_require__.d(__webpack_exports__, "heat_load_api_day", function() { return __WEBPACK_IMPORTED_MODULE_4__data_service__["_37"]; });
/* harmony namespace reexport (by used) */ __webpack_require__.d(__webpack_exports__, "heat_load_api_month", function() { return __WEBPACK_IMPORTED_MODULE_4__data_service__["_38"]; });
/* harmony namespace reexport (by used) */ __webpack_require__.d(__webpack_exports__, "heat_load_api_year", function() { return __WEBPACK_IMPORTED_MODULE_4__data_service__["_39"]; });
/* harmony namespace reexport (by used) */ __webpack_require__.d(__webpack_exports__, "leftPanelSize", function() { return __WEBPACK_IMPORTED_MODULE_4__data_service__["_46"]; });
/* harmony namespace reexport (by used) */ __webpack_require__.d(__webpack_exports__, "rightPanelSize", function() { return __WEBPACK_IMPORTED_MODULE_4__data_service__["_47"]; });
...
var SnapshotService = (function () {
    ...
    SnapshotService.prototype.add = function (name, description) {
        ...
        var config = {
            ...
            date: new Date(),
            scale: scale,
            zones: scale !== __WEBPACK_IMPORTED_MODULE_8__data_service__["g" /* hectare */] ? this.slcToolsService.nutsIdsSubject.getValue()
    ...
    SnapshotService.prototype.apply = function (snapshot, callback) {
        ...
        var layers2Toggle = [];
        {
            ...
            for (var i = 0; i < lay_1.length; i++) {
                ...
                if (add) {
                    __WEBPACK_IMPORTED_MODULE_10__features_layers_interaction_layers_interaction_data__["b" /* DataInteractionArray */].forEach(function (dataInteraction) {
        ...
        var nutLvl = __WEBPACK_IMPORTED_MODULE_9__business__["b" /* NutsRenderArray */].find(function (nut) { return nut.business_name == snapshot.scale; });
        // To change scale
        ...
        if (nutLvl) {
            if (nutLvl.business_name != __WEBPACK_IMPORTED_MODULE_8__data_service__["g" /* hectare */]) {
                ...
                var layer = isLau2 ? __WEBPACK_IMPORTED_MODULE_8__data_service__["U" /* lau2name */] : 'population';
                ...
                var url = __WEBPACK_IMPORTED_MODULE_8__data_service__["R" /* geoserverUrl */] + '?service=WFS&version=2.0.0&request=GetFeature' +
...
var UploadService = (function (_super) {
    ...
    UploadService.prototype.export = function (layer, schema, year) {
        ...
        var isNuts = true;
        if (year == null)
            year = __WEBPACK_IMPORTED_MODULE_8__shared_data_service__["d" /* constant_year */];
        if (schema == null)
            schema = layerExportInfo.schema;
        if (scale === __WEBPACK_IMPORTED_MODULE_8__shared_data_service__["e" /* lau2 */] || scale === __WEBPACK_IMPORTED_MODULE_8__shared_data_service__["f" /* nuts3 */]) {
            layer += '_' + scale.toLowerCase().replace(' ', ''); // To change in API ?
            nutsOrAreas = this.slcToolsService.nutsIdsSubject.getValue();
        }
        else if (scale === __WEBPACK_IMPORTED_MODULE_8__shared_data_service__["g" /* hectare */]) {
            layer += '_ha';
