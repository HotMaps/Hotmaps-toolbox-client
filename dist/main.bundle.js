...
var ExportDataComponent = (function () {
    function ExportDataComponent(exportDataService, logger, helper) {
        ...
        this.tabsSelectedName = __WEBPACK_IMPORTED_MODULE_4__shared_data_service__["Q" /* tab1_datapanel */];
    ...
    ExportDataComponent.prototype.export = function () {
        if (this.tabSelected === __WEBPACK_IMPORTED_MODULE_4__shared_data_service__["Q" /* tab1_datapanel */]) {
...
var DurationCurveService = (function (_super) {
    ...
    DurationCurveService.prototype.getDurationCurveWithPayload = function (payload, isHectare) {
        if (isHectare === false) {
            ...
            return _super.prototype.POST.call(this, payload, __WEBPACK_IMPORTED_MODULE_8__shared_data_service__["a" /* apiUrl */] + __WEBPACK_IMPORTED_MODULE_8__shared_data_service__["O" /* postDurationCurveNutsLau */]);
        }
        else {
            this.logger.log('DurationCurveService/getDurationCurveWithPayload = ' + JSON.stringify(payload));
            return _super.prototype.POST.call(this, payload, __WEBPACK_IMPORTED_MODULE_8__shared_data_service__["a" /* apiUrl */] + __WEBPACK_IMPORTED_MODULE_8__shared_data_service__["P" /* postDurationCurveHectares */]);
        }
    };
...
var ElectricityMixService = (function (_super) {
    ...
    ElectricityMixService.prototype.getElectricityMix = function (payload) {
        this.logger.log(__WEBPACK_IMPORTED_MODULE_7_app_shared_data_service__["a" /* apiUrl */] + __WEBPACK_IMPORTED_MODULE_7_app_shared_data_service__["M" /* postHeatLoadProfileHectares */]);
        return _super.prototype.POST.call(this, payload, __WEBPACK_IMPORTED_MODULE_7_app_shared_data_service__["a" /* apiUrl */] + __WEBPACK_IMPORTED_MODULE_7_app_shared_data_service__["N" /* getElectricityMixFromNuts0 */]);
    };
...
var HeatLoadAggregateService = (function (_super) {
    ...
    HeatLoadAggregateService.prototype.getHeatLoad = function (payload, type_api_ref, isHectare) {
        if (isHectare === false) {
            ...
            this.logger.log('postHeatLoadProfileHectares ' + __WEBPACK_IMPORTED_MODULE_8__shared_data_service__["a" /* apiUrl */] + __WEBPACK_IMPORTED_MODULE_8__shared_data_service__["M" /* postHeatLoadProfileHectares */] + type_api_ref + ' ; payload:' + JSON.stringify(payload));
            this.logger.log(__WEBPACK_IMPORTED_MODULE_8__shared_data_service__["a" /* apiUrl */] + __WEBPACK_IMPORTED_MODULE_8__shared_data_service__["M" /* postHeatLoadProfileHectares */]);
            return _super.prototype.POST.call(this, payload, __WEBPACK_IMPORTED_MODULE_8__shared_data_service__["a" /* apiUrl */] + __WEBPACK_IMPORTED_MODULE_8__shared_data_service__["M" /* postHeatLoadProfileHectares */]);
        }
    };
    ...
    LayerToolComponent.prototype.ngOnInit = function () {
        ...
        if (this.mapService.getLoadResultbuttonState()) {
            this.mapService.getLoadResultbuttonState().subscribe(function (value) { return _this.hasZoneSelected = value
                && [__WEBPACK_IMPORTED_MODULE_4__shared_data_service__["p" /* nuts3 */], __WEBPACK_IMPORTED_MODULE_4__shared_data_service__["c" /* lau2 */], __WEBPACK_IMPORTED_MODULE_4__shared_data_service__["b" /* hectare */]].indexOf(_this.mapService.getScaleValue()) > -1; });
        }
    };
        ...
        if (this.mapService.getNutsSelectedSubject()) {
            this.mapService.getNutsSelectedSubject().subscribe(function (value) {
                ...
                if (value === 0) {
                    ...
                    if (_this.scaleLevel === __WEBPACK_IMPORTED_MODULE_10__shared_data_service__["b" /* hectare */]) {
...
var MapService = (function (_super) {
    ...
    */
    ...
    MapService.prototype.getNutsGeometryFromLau2 = function (latlng, nuts_level) {
        var bbox = latlng.toBounds(__WEBPACK_IMPORTED_MODULE_3__shared_data_service__["_20" /* clickAccuracy */]).toBBoxString();
        var action = __WEBPACK_IMPORTED_MODULE_3__shared_data_service__["d" /* lau2name */];
        var url = __WEBPACK_IMPORTED_MODULE_3__shared_data_service__["_21" /* geoserverGetFeatureInfoUrl */]
            + action + '&STYLES&LAYERS=hotmaps:' + action + '&INFO_FORMAT=application/json&FEATURE_COUNT=50' +
            '&X=50&Y=50&SRS=EPSG:4326&WIDTH=101&HEIGHT=101&BBOX=' + bbox;
...
var NutsRenderArray = [
    { id: 0, api_name: '0', business_name: __WEBPACK_IMPORTED_MODULE_0__data_service__["m" /* nuts0 */], suffix: '' },
    { id: 1, api_name: '1', business_name: __WEBPACK_IMPORTED_MODULE_0__data_service__["n" /* nuts1 */], suffix: '' },
    { id: 2, api_name: '2', business_name: __WEBPACK_IMPORTED_MODULE_0__data_service__["o" /* nuts2 */], suffix: '' },
    { id: 3, api_name: '3', business_name: __WEBPACK_IMPORTED_MODULE_0__data_service__["p" /* nuts3 */], suffix: '' },
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "P", function() { return postDurationCurveHectares; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "O", function() { return postDurationCurveNutsLau; });
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "Q", function() { return tab1_datapanel; });
...
var localApiUrl = 'http://153.109.130.123:5000/api';
...
var SnapshotService = (function () {
    ...
    SnapshotService.prototype.add = function (name, description) {
        ...
        var config = {
            ...
            date: new Date(),
            scale: scale,
            zones: scale !== __WEBPACK_IMPORTED_MODULE_8__data_service__["b" /* hectare */] ? this.slcToolsService.nutsIdsSubject.getValue()
    ...
    SnapshotService.prototype.apply = function (snapshot, callback) {
        ...
        if (nutLvl) {
            if (nutLvl.business_name != __WEBPACK_IMPORTED_MODULE_8__data_service__["b" /* hectare */]) {
                // Working but a little slow
                var isLau2 = nutLvl.business_name == __WEBPACK_IMPORTED_MODULE_8__data_service__["c" /* lau2 */];
                var nameId = isLau2 ? 'comm_id' : 'nuts_id';
                var layer = isLau2 ? __WEBPACK_IMPORTED_MODULE_8__data_service__["d" /* lau2name */] : 'population';
                ...
                var url = __WEBPACK_IMPORTED_MODULE_8__data_service__["e" /* geoserverUrl */] + '?service=WFS&version=2.0.0&request=GetFeature' +
...
var UploadService = (function (_super) {
    ...
    UploadService.prototype.add = function (file, layer) {
        ...
        return _super.prototype.POSTunStringify.call(this, form, uploadUrl + 'add', { headers: new __WEBPACK_IMPORTED_MODULE_1__angular_http__["c" /* Headers */]() })
            .then(function (response) { return _this.showMsg(response, true); })
            .catch(function (response) { return _this.showMsg(response, false); });
    };
    /**
    ...
    UploadService.prototype.download = function (id) {
        ...
        }, uploadUrl + 'download', { responseType: __WEBPACK_IMPORTED_MODULE_1__angular_http__["d" /* ResponseContentType */].Blob, headers: new __WEBPACK_IMPORTED_MODULE_1__angular_http__["c" /* Headers */]() }).then(function (data) { return URL.createObjectURL(data); }).catch(function (err) {
...
module.exports = __webpack_require__.p + "circle.dad48d32d81577a8088a.svg";
...
module.exports = __webpack_require__.p + "cursor.45fdd9d5fc5002281f29.svg";
...
module.exports = __webpack_require__.p + "polygon.5f6dfcbbea42d79cfcb0.svg";
...
module.exports = __webpack_require__.p + "square.cb535f185d77464be363.svg";
