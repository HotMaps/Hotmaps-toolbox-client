...
var DataInteractionArray = [
    ...
    { id: __WEBPACK_IMPORTED_MODULE_0__shared_data_service__["w" /* idDefaultLayer */], name: 'Heat Map', category: 'Comsumption', isSelected: true, workspaceName: __WEBPACK_IMPORTED_MODULE_0__shared_data_service__["v" /* defaultLayer */], zoomLevel: 0 },
...
var FeedbackComponent = (function () {
    ...
    FeedbackComponent.prototype.sendRequest = function (f) {
        ...
        jQuery.ajax({
            url: __WEBPACK_IMPORTED_MODULE_5__shared_data_service__["Z" /* urlTaigaFeedback */],
            type: 'POST',
            data: fd,
            processData: false,
            contentType: false,
...
var LayersService = (function (_super) {
    ...
    function LayersService(http, logger, loaderService, toasterService, 
        ...
        _this.heatmapOption = {
            layers: 'hotmaps:' + __WEBPACK_IMPORTED_MODULE_8__shared_data_service__["v" /* defaultLayer */] + '_ha' + '_' + __WEBPACK_IMPORTED_MODULE_8__shared_data_service__["u" /* constant_year */],
            format: __WEBPACK_IMPORTED_MODULE_8__shared_data_service__["f" /* formatImage */], transparent: true, version: '1.3.0',
        ...
        _this.layersArray = new __WEBPACK_IMPORTED_MODULE_7__shared_class_dictionary_class__["a" /* Dictionary */]([
            {
                key: __WEBPACK_IMPORTED_MODULE_8__shared_data_service__["v" /* defaultLayer */], value: _this.getTilayer(_this.heatmapOption, _this.loaderService)
            },
        ]);
        _this.popup = L.popup();
        return _this;
    ...
    LayersService.prototype.setupDefaultLayer = function () {
        var layer = this.layersArray.value(__WEBPACK_IMPORTED_MODULE_8__shared_data_service__["v" /* defaultLayer */]);
    ...
    LayersService.prototype.addLayerWithAction = function (action, map, order) {
        ...
        if (action === __WEBPACK_IMPORTED_MODULE_8__shared_data_service__["t" /* wwtpLayerName */]) {
            var option = {
                ...
                format: __WEBPACK_IMPORTED_MODULE_8__shared_data_service__["f" /* formatImage */],
                transparent: true,
                version: '1.3.0',
            ...
            var option = {
                layers: 'hotmaps:' + action + '_ha' + '_' + __WEBPACK_IMPORTED_MODULE_8__shared_data_service__["u" /* constant_year */],
                format: __WEBPACK_IMPORTED_MODULE_8__shared_data_service__["f" /* formatImage */],
                transparent: true,
                version: '1.3.0',
                srs: 'EPSG:4326',
    ...
    LayersService.prototype.choosePopup = function (map, res, latlng, action) {
        if (this.layersArray.containsKey(__WEBPACK_IMPORTED_MODULE_8__shared_data_service__["v" /* defaultLayer */])) {
        ...
        else if (action === __WEBPACK_IMPORTED_MODULE_8__shared_data_service__["x" /* populationLayerName */] + '_' + __WEBPACK_IMPORTED_MODULE_8__shared_data_service__["u" /* constant_year */]) {
...
var hectareOption = {
    ...
    format: __WEBPACK_IMPORTED_MODULE_0__shared_data_service__["f" /* formatImage */],
    transparent: true,
    version: '1.3.0',
...
var lau2LayerOption = {
    layers: 'hotmaps:' + __WEBPACK_IMPORTED_MODULE_0__shared_data_service__["g" /* lau2name */],
    format: __WEBPACK_IMPORTED_MODULE_0__shared_data_service__["f" /* formatImage */],
    transparent: true,
    version: '1.3.0',
    zIndex: 10
...
var SelectionToolService = (function (_super) {
    ...
    SelectionToolService.prototype.getStatisticsFromIds = function (nutsIds, layers, map) {
        ...
        var payload = { layers: layers, year: __WEBPACK_IMPORTED_MODULE_3__shared_data_service__["u" /* constant_year */], nuts: nutsIds };
        ...
        if ((this.scaleValue === __WEBPACK_IMPORTED_MODULE_3__shared_data_service__["p" /* nuts2 */]) || (this.scaleValue === __WEBPACK_IMPORTED_MODULE_3__shared_data_service__["q" /* nuts3 */])) {
    ...
    SelectionToolService.prototype.getStatisticsFromLayer = function (locations, layers, map) {
        ...
        var request = [];
        this.loaderService.display(true);
        var payload = { layers: layers, year: __WEBPACK_IMPORTED_MODULE_3__shared_data_service__["u" /* constant_year */], points: locations };
...
var SummaryResultComponent = (function () {
    function SummaryResultComponent(summaryResultService, selectionScaleService, logger) {
        ...
        this.round = __WEBPACK_IMPORTED_MODULE_3__shared_data_service__["j" /* round_value */];
        this.scale = 'Nuts 3';
    ...
    SummaryResultComponent.prototype.ngOnChanges = function () {
        ...
        if (this.selectionScaleService.getScaleValue() !== __WEBPACK_IMPORTED_MODULE_3__shared_data_service__["s" /* hectare */]) {
...
var SummaryResultService = (function (_super) {
    ...
    SummaryResultService.prototype.getSummaryResultWithPayload = function (payload) {
        ...
        return _super.prototype.POST.call(this, payload, __WEBPACK_IMPORTED_MODULE_8__shared_data_service__["a" /* apiUrl */] + __WEBPACK_IMPORTED_MODULE_8__shared_data_service__["h" /* postStatsLayersArea */]);
    };
    SummaryResultService.prototype.getSummaryResultWithIds = function (payload) {
        ...
        return _super.prototype.POST.call(this, payload, __WEBPACK_IMPORTED_MODULE_8__shared_data_service__["a" /* apiUrl */] + __WEBPACK_IMPORTED_MODULE_8__shared_data_service__["i" /* postStatsLayersNutsIds */]);
    };
...
var MapService = (function (_super) {
    ...
    */
    ...
    MapService.prototype.getNutsGeometryFromLau2 = function (latlng, nuts_level) {
        var bbox = latlng.toBounds(__WEBPACK_IMPORTED_MODULE_2__shared_data_service__["S" /* clickAccuracy */]).toBBoxString();
        var action = __WEBPACK_IMPORTED_MODULE_2__shared_data_service__["g" /* lau2name */];
        var url = __WEBPACK_IMPORTED_MODULE_2__shared_data_service__["T" /* geoserverGetFeatureInfoUrl */]
            + action + '&STYLES&LAYERS=hotmaps:' + action + '&INFO_FORMAT=application/json&FEATURE_COUNT=50' +
            '&X=50&Y=50&SRS=EPSG:4326&WIDTH=101&HEIGHT=101&BBOX=' + bbox;
...
var NutsRenderArray = [
    { id: 0, api_name: '0', business_name: __WEBPACK_IMPORTED_MODULE_0__data_service__["n" /* nuts0 */], suffix: '_nuts0' },
    { id: 1, api_name: '1', business_name: __WEBPACK_IMPORTED_MODULE_0__data_service__["o" /* nuts1 */], suffix: '_nuts1' },
    { id: 2, api_name: '2', business_name: __WEBPACK_IMPORTED_MODULE_0__data_service__["p" /* nuts2 */], suffix: '_nuts2' },
    { id: 3, api_name: '3', business_name: __WEBPACK_IMPORTED_MODULE_0__data_service__["q" /* nuts3 */], suffix: '_nuts3' },
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "v", function() { return defaultLayer; });
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "Z", function() { return urlTaigaFeedback; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "_0", function() { return timeOutAjaxRequest; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "Y", function() { return unit_heatload_profil; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "f", function() { return formatImage; });
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "h", function() { return postStatsLayersArea; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "b", function() { return postHeatLoadAggregateMonth; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "i", function() { return postStatsLayersNutsIds; });
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "j", function() { return round_value; });
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "g", function() { return lau2name; });
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "_2", function() { return rightPanelSize; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "_1", function() { return leftPanelSize; });
...
var Helper = (function () {
    ...
    Helper.prototype.round = function (num) {
        ...
        ;
        return this.decimalPipe.transform(num, __WEBPACK_IMPORTED_MODULE_3__data_service__["j" /* round_value */]);
    };
...
/* harmony namespace reexport (by used) */ __webpack_require__.d(__webpack_exports__, "lau2name", function() { return __WEBPACK_IMPORTED_MODULE_4__data_service__["g"]; });
...
/* harmony namespace reexport (by used) */ __webpack_require__.d(__webpack_exports__, "unit_heatload_profil", function() { return __WEBPACK_IMPORTED_MODULE_4__data_service__["Y"]; });
/* harmony namespace reexport (by used) */ __webpack_require__.d(__webpack_exports__, "timeOutAjaxRequest", function() { return __WEBPACK_IMPORTED_MODULE_4__data_service__["_0"]; });
/* harmony namespace reexport (by used) */ __webpack_require__.d(__webpack_exports__, "leftPanelSize", function() { return __WEBPACK_IMPORTED_MODULE_4__data_service__["_1"]; });
/* harmony namespace reexport (by used) */ __webpack_require__.d(__webpack_exports__, "rightPanelSize", function() { return __WEBPACK_IMPORTED_MODULE_4__data_service__["_2"]; });
