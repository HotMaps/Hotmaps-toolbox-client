...
var PopulationService = (function (_super) {
    ...
    PopulationService.prototype.getPopulationWithPayloads = function (payload) {
        return _super.prototype.POST.call(this, payload, __WEBPACK_IMPORTED_MODULE_4__shared_data_service__["e" /* apiUrl */] + __WEBPACK_IMPORTED_MODULE_4__shared_data_service__["E" /* postPopulationDensityInArea */]);
    };
    ...
    PopulationService.prototype.addPopupNuts = function (data, map, latlng, popup) {
        ...
        var date = data.features[0].properties.date.split('Z')[0];
        popup.setLatLng(latlng).setContent('<h5>' + __WEBPACK_IMPORTED_MODULE_4__shared_data_service__["F" /* business_name_population */] + '</h5> <ul class="uk-list uk-list-divider">' +
...
var MapComponent = (function () {
    ...
    MapComponent.prototype.createMap = function (basemap) {
        ...
        var self = this;
        this.map = L.map('map', __WEBPACK_IMPORTED_MODULE_1__shared_data_service__["D" /* map_options */]);
...
var MapService = (function (_super) {
    ...
    MapService.prototype.retriveMapEvent = function (map) {
        ...
        this.map.on('click', function (e) {
            ...
            else if (self.selectionScaleService.getScaleValue() === __WEBPACK_IMPORTED_MODULE_6__shared_data_service__["o" /* hectare */]) {
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "F", function() { return business_name_population; });
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "D", function() { return map_options; });
