...
var DataInteractionArray = [
    ...
    { id: 12, name: __WEBPACK_IMPORTED_MODULE_0__shared_data_service__["p" /* business_name_wwtp */], category: 'Ressources', isSelected: false, workspaceName: 'wwtp' },
    { id: 14, name: 'Population', category: 'Comsumption', isSelected: false, workspaceName: __WEBPACK_IMPORTED_MODULE_0__shared_data_service__["m" /* populationLayerName */] },
];
...
var LayersService = (function (_super) {
    ...
    LayersService.prototype.choosePopup = function (map, res, latlng, action) {
        ...
        else if (action === __WEBPACK_IMPORTED_MODULE_5__shared_data_service__["m" /* populationLayerName */] + '_' + __WEBPACK_IMPORTED_MODULE_5__shared_data_service__["k" /* constant_year */]) {
    ...
    LayersService.prototype.addPopupHectare = function (map, data, latlng) {
        ...
        this.popup.setLatLng(latlng)
            ...
            ' <li>Population density: ' + this.helper.round(population_density) + ' ' + __WEBPACK_IMPORTED_MODULE_5__shared_data_service__["n" /* unit_population */] + '</li> </ul>')
            .openOn(map);
    };
    LayersService.prototype.addPopupHeatmap = function (map, data, latlng) {
        ...
        this.popup.setLatLng(latlng)
            ...
            ' <li>Heat demand: ' + this.helper.round(heat_density) + ' ' + __WEBPACK_IMPORTED_MODULE_5__shared_data_service__["o" /* unit_heat_density */] + '</li> </ul>')
            .openOn(map);
    };
    LayersService.prototype.addPopupWWTP = function (map, data, latlng) {
        ...
        this.popup.setLatLng(latlng).setContent('<h5>' + __WEBPACK_IMPORTED_MODULE_5__shared_data_service__["p" /* business_name_wwtp */] + '</h5> <ul class="uk-list uk-list-divider">' +
            '<li>Capacity: ' + capacity + ' ' + __WEBPACK_IMPORTED_MODULE_5__shared_data_service__["q" /* unit_capacity */] + '</li><li>Power: ' + this.helper.round(power) + ' ' + unit + '</li>' +
...
var PopulationService = (function (_super) {
    ...
    PopulationService.prototype.addPopupNuts = function (data, map, latlng, popup) {
        ...
        popup.setLatLng(latlng).setContent('<h5>' + __WEBPACK_IMPORTED_MODULE_4__shared_data_service__["y" /* business_name_population */] + '</h5> <ul class="uk-list uk-list-divider">' +
            ...
            '<li>Population: ' + this.helper.round(value) + ' ' + __WEBPACK_IMPORTED_MODULE_4__shared_data_service__["n" /* unit_population */] + '</li><li>Reference date: ' + date + '</li></ul>').openOn(map);
...
var SummaryResultComponent = (function () {
    function SummaryResultComponent(summaryResultService, selectionScaleService, logger) {
        ...
        this.logger = logger;
        this.expandedState = 'collapsed';
        this.round = __WEBPACK_IMPORTED_MODULE_3__shared_data_service__["r" /* round_value */];
        this.scale = 'Nuts 3';
...
var MapService = (function (_super) {
    ...
    MapService.prototype.getNutsGeometryFromNuts = function (latlng, nuts_level) {
        ...
        var bbox = latlng.toBounds(__WEBPACK_IMPORTED_MODULE_9__shared_data_service__["s" /* clickAccuracy */]).toBBoxString();
        bbox = bbox + '&CQL_FILTER=' + 'stat_levl_=' + current_nuts_level + 'AND ' + 'date=' + '2015' + '-01-01Z';
        var action = 'population';
        var url = __WEBPACK_IMPORTED_MODULE_9__shared_data_service__["t" /* geoserverGetFeatureInfoUrl */]
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "m", function() { return populationLayerName; });
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "p", function() { return business_name_wwtp; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "y", function() { return business_name_population; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "q", function() { return unit_capacity; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "o", function() { return unit_heat_density; });
/* unused harmony export unit_shape_area */
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "n", function() { return unit_population; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "r", function() { return round_value; });
...
var Helper = (function () {
    ...
    Helper.prototype.round = function (num) {
        ...
        ;
        return this.decimalPipe.transform(num, __WEBPACK_IMPORTED_MODULE_3__data_service__["r" /* round_value */]);
    };
    return Helper;
}());
Helper = __decorate([
