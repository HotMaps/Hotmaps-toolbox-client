...
const prodUrl    = 'http://api.hotmaps.hevs.ch/api';
const api_prod_Url    = 'http://api.hotmaps.hevs.ch/api';
const devUrl    = 'http://api.hotmaps.hevs.ch/api';
const localApiUrl    = 'http://localhost:5000/api';



export const geoserverProdUrl = 'http://geoserver.hotmaps.hevs.ch/geoserver/hotmaps/wms';
export const geoserverDevUrl = 'http://geoserver.hotmaps.hevs.ch/geoserver/hotmaps/wms';
...
export const getLocationFromIp    = 'http://api.hotmaps.hevs.ch/api';
