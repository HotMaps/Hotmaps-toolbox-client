...
export const BusinessInterfaceRenderArray: BusinessInterfaceRenderClass[] = [
  ...
  {id: 172, api_name: 'heat_density_nuts3', business_name: 'Heat map'},
  {id: 174, api_name: 'heat_density_nuts2', business_name: 'Heat map'},
  {id: 175, api_name: 'heat_density_nuts1', business_name: 'Heat map'},
  {id: 176, api_name: 'heat_density_nuts0', business_name: 'Heat map'},
