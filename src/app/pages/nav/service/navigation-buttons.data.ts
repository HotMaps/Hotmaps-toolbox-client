...
export const navigationButtons: NavigationButton[] = [
  ...
  /*   
  { id: 'save', title: 'Save', buttonFunction: 'save', iconClass: 'flaticon-technology-2', enable: true, stateOpen: false},
  { id: 'folder', title: 'Folder', buttonFunction: 'folder', iconClass: 'flaticon-folder-2', enable: true, stateOpen: false},
