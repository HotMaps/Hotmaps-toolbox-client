...
export const DataInteractionArray: DataInteractionClass[] = [
 // {id: 11, name: 'Heat map', category: 'Comsumption'},
  ...
  {id: idDefaultLayer, name: 'Heat density total', category: 'Buildings', isSelected: true,
    workspaceName: defaultLayer, zoomLevel: 0, ref:['summary', 'demand', 'load_profile', 'heat_supply'], styleName: styleNameHeat},
  {id: 15, name: 'Heat density residential sector', category: 'Buildings', isSelected: false,
    workspaceName: 'heat_res_curr_density', zoomLevel: 0, ref: ['summary', 'demand', 'heat_supply'], styleName: styleNameHeat},
  {id: 16, name: 'Heat density non-residential sector', category: 'Buildings', isSelected: false,
    workspaceName: 'heat_nonres_curr_density', zoomLevel: 0, ref: ['summary', 'heat_supply'], styleName: styleNameHeat},

  {id: 12, name: business_name_wwtp + ' Power', category: 'R.E.S. Potential', isSelected: false,
    workspaceName: 'wwtp_power', zoomLevel: zoomLevelDetectChange, ref: ['climate'], styleName: styleNameHeat},
  {id: 12, name: business_name_wwtp + ' Capacity', category: 'R.E.S. Potential', isSelected: false,
    workspaceName: 'wwtp_capacity',  zoomLevel: zoomLevelDetectChange, ref: ['climate'], styleName: styleNameHeat},
  ...
  {id: 19, name: 'Gross floor area residential', category: 'Buildings', isSelected: false,
    workspaceName: 'gfa_res_curr_density', zoomLevel: 0, ref: ['summary'], styleName: styleNameHeat},
  {id: 20, name: 'Gross floor area non residential', category: 'Buildings', isSelected: false,
    workspaceName: 'gfa_nonres_curr_density', zoomLevel: 0, ref: ['summary'], styleName: styleNameHeat},
  ...
  {id: 20, name: 'Wind potential', category: 'Res Potential', isSelected: false,
    workspaceName: 'potential_wind', zoomLevel: 0, ref: ['potential', 'climate'], styleName: styleNameHeat},
