import { hotmaps_wiki } from "app/shared"

export const standaloneCMs = [
    {
        name: "CM - CUSTOMIZED HEAT AND GROSS FLOOR AREA DENSITY MAPS",
        wiki_url: hotmaps_wiki + "/en/CM-Customized-heat-and-floor-area-density-maps",
    ...
    },
    {
        ...
        wiki_url: hotmaps_wiki + "/en/CM-Scenario-assessment",
