...
// Potentials
  ...
  {id: idDefaultLayer, name: 'Agricultural residues', category: 'R.E.S. Potential', isSelected: false,
    ...
    description: 'Information on the layer can be found here: ' + gitlabUrl + '/potential/potential_biomass/blob/master/README.md', isLoading:false, year:1970, schema:'public'},
  ...
  {id: idDefaultLayer, name: 'Municipal solid waste', category: 'R.E.S. Potential', isSelected: false,
    ...
    description: 'Information on the layer can be found here: ' + gitlabUrl + '/potential/potential_municipal_solid_waste/blob/master/README.md', isLoading:false, year:1970, schema:'public'},
...
// Electricity
  {id: idDefaultLayer, name: 'Electricity CO2 emissions - country average', category: 'Electricity', isSelected: false,
    ...
    description: 'Information on the layer can be found here: ' + gitlabUrl + '/load_electricity/electricity_emissions_hourly/blob/master/README.md', isLoading:false, year:2015, schema:'geo'},
